...
Route::middleware(['auth', 'verified'])->prefix('dashboard')->name('dashboard.')->group(function () {
    ...
    Route::get('/history/{tryout}', [HistoryController::class, 'show'])->name('history.show');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('tryouts')->name('tryouts.')->group(function () {
        ...
        Route::get('/{tryout}/soal', [TryoutController::class, 'questionByFirst'])->name('question');
            Route::get('/{tryout}/question/{questionNumber}', [TryoutController::class, 'questionByNumber'])->name('question.by-number');
            Route::get('/{tryout}/check-answer/{questionNumber}', [TryoutController::class, 'checkAnswer'])->name('check-answer');
        Route::post('/{tryout}/answer', [TryoutController::class, 'answer'])->name('answer');
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/activity-logs/auth', [ActivityLogController::class, 'authLogs'])->name('activity-logs.auth');
        Route::get('/activity-logs/user-activities', [ActivityLogController::class, 'userActivityLogs'])->name('activity-logs.user-activities');
    });
});
