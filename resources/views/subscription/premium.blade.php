            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-blue-700">
                        Langganan aktif hingga {{ $currentSubscription->tanggal_akhir->format('d F Y') }}
                    </p>
                </div>
    ...
    <div class="grid lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-8">
                ...
                <!-- Action Button -->
                <form id="individualUpgradeForm" method="POST" action="{{ route('subscription.subscribe') }}">
                    @csrf
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-8">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-blue-700">{{ auth()->user()->email }}</div>
                                </div>
                            </div>
                ...
                <!-- Action Button -->
                <form id="bulkUpgradeForm" method="POST" action="{{ route('subscription.subscribe-bulk') }}">
                    @csrf
