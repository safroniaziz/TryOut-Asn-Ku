...
<?php $component->withAttributes([]); ?>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center">
                <div class="inline-flex items-center px-6 py-3 bg-white/5 backdrop-blur-md rounded-full border border-white/10">
                    <i class="fas fa-filter text-white/70 mr-3 text-sm"></i>
                    <span class="text-white/80 text-sm font-medium">
                        <?php if(request('type') === 'CPNS'): ?>
                            Paket TryOut CPNS - Calon Pegawai Negeri Sipil
                        <?php elseif(request('type') === 'PPPK'): ?>
    ...
    <div class="bg-gradient-to-br from-slate-50 to-blue-50 pb-12">
        ...
        <div x-show="cpnsActiveTab === 'all'" x-transition:enter="transition ease-out duration-300"
            ...
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $cpnsPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php echo $__env->make('partials.package-card', ['package' => $package, 'hasPremium' => $hasPremium], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div x-show="cpnsActiveTab === 'SKD'" x-transition:enter="transition ease-out duration-300"
            ...
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $skdPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php echo $__env->make('partials.package-card', ['package' => $package, 'hasPremium' => $hasPremium], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-12">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8">
        ...
        <div x-show="cpnsActiveTab === 'SKB'" x-transition:enter="transition ease-out duration-300"
            ...
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $skbPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php echo $__env->make('partials.package-card', ['package' => $package, 'hasPremium' => $hasPremium], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-12">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8">
    ...
    <div class="bg-gradient-to-br from-emerald-50 to-green-50 pb-12">
        ...
        <div x-show="pppkActiveTab === 'all'" x-transition:enter="transition ease-out duration-300"
            ...
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $pppkPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php echo $__env->make('partials.package-card', ['package' => $package, 'hasPremium' => $hasPremium], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-12">
        ...
        <div x-show="pppkActiveTab === 'Non-Teknis'" x-transition:enter="transition ease-out duration-300"
            ...
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $nonTeknisPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php echo $__env->make('partials.package-card', ['package' => $package, 'hasPremium' => $hasPremium], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-12">
                    <div class="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-8">
        ...
        <div x-show="pppkActiveTab === 'Teknis'" x-transition:enter="transition ease-out duration-300"
            ...
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $teknisPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php echo $__env->make('partials.package-card', ['package' => $package, 'hasPremium' => $hasPremium], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-12">
                    <div class="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-8">
...
<?php /**PATH /var/www/html/resources/views/tryouts/index.blade.php ENDPATH**/ ?>