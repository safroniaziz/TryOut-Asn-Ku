...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="relative w-full z-50 transition-all duration-500 bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm" id="navbar">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Navbar sudah tidak fixed, jadi tidak perlu scroll effects lagi
