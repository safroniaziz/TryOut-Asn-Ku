...
<body class="font-inter antialiased overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-2">
                    <a href="#features" class="nav-item relative px-6 py-3 font-bold text-gray-700 hover:text-blue-600 transition-all duration-300 rounded-xl hover:bg-blue-50 group">
                    ...
                    <a href="#testimonials" class="nav-item relative px-6 py-3 font-bold text-gray-700 hover:text-purple-600 transition-all duration-300 rounded-xl hover:bg-purple-50 group">
                    ...
                    <a href="#contact" class="nav-item relative px-6 py-3 font-bold text-gray-700 hover:text-green-600 transition-all duration-300 rounded-xl hover:bg-green-50 group">
                        <span class="relative z-10">Kontak</span>
                        <div class="absolute -bottom-1 left-2 right-2 h-0.5 bg-gradient-to-r from-green-500 to-green-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
                    </a>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="relative overflow-hidden bg-gradient-to-r from-slate-700 via-slate-800 to-gray-900 text-white px-8 py-3 rounded-xl font-bold transition-all duration-300 hover:shadow-xl hover:scale-105 group border border-slate-600">
            ...
            <div class="bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-xl">
                <div class="max-w-7xl mx-auto px-4 py-6">
                    ...
                    <div class="space-y-3 mb-6">
                        <a href="#features" class="flex items-center space-x-4 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 transition-all duration-300 group border border-blue-200/50">
                            <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-star text-white text-sm"></i>
                            </div>
                            <span class="font-bold text-gray-800 group-hover:text-blue-700">Fitur Premium</span>
                        </a>
                        ...
                        <a href="#testimonials" class="flex items-center space-x-4 p-4 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 hover:from-purple-100 hover:to-indigo-100 transition-all duration-300 group border border-purple-200/50">
                            ...
                            <span class="font-bold text-gray-800 group-hover:text-purple-700">Testimoni</span>
                        </a>

                        <a href="#contact" class="flex items-center space-x-4 p-4 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 transition-all duration-300 group border border-green-200/50">
                            ...
                            <span class="font-bold text-gray-800 group-hover:text-green-700">Kontak Kami</span>
                        </a>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="col-span-2 relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-600 text-white p-4 rounded-xl font-bold text-center transition-all duration-300 hover:shadow-lg group">
                                <div class="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        ...
                        @else
                            <a href="{{ route('login') }}" class="relative overflow-hidden bg-gradient-to-r from-slate-700 via-slate-800 to-gray-900 text-white p-4 rounded-xl font-bold text-center transition-all duration-300 hover:shadow-lg group border border-slate-600">
                                <div class="absolute inset-0 bg-gradient-to-r from-blue-600 to-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                <span class="relative z-10">
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="relative overflow-hidden bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 text-white p-4 rounded-xl font-bold text-center transition-all duration-300 hover:shadow-lg group">
                                    <div class="absolute inset-0 bg-gradient-to-r from-orange-400 to-red-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                    <span class="relative z-10">
                                        <i class="fas fa-rocket mr-1"></i>Daftar
                                    </span>
                                </a>
                            @endif
                        @endauth
    ...
    <section class="py-20 bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 relative overflow-hidden">
