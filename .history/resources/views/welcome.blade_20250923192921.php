        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed px-4">
                    Platform tryout <span class="whitespace-nowrap">modern dengan</span> fitur lengkap dan user experience terbaik untuk persiapan CPNS & PPPK
                </p>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function openMobileMenu() {
                ...
                console.log('Current menu style after:', mobileMenu.style.cssText);
            ...
            function closeMobileMenu() {
                ...
                mobileMenuBtn.addEventListener('click', function(e) {
                    ...
                    const isOpen = mobileMenu.classList.contains('translate-y-0') || mobileMenu.style.transform === 'translateY(0px)';
