<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
                    <i class="fas fa-chart-line mr-3"></i>Dashboard Analytics
                </h2>
            ...
            @if(!$hasPremium)
                <a href="{{ route('subscription.premium') }}" class="group relative bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 hover:from-amber-600 hover:via-orange-600 hover:to-red-600 text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl overflow-hidden">
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in-up">
                ...
                <div class="group relative bg-gradient-to-br from-blue-50 to-indigo-100 backdrop-blur-xl rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-blue-200/50 overflow-hidden">
                            ...
                            @if($progressData['total_tryouts_available'] > 0)
                                <div class="flex items-center space-x-2">
                                    <div class="flex-1 bg-gray-200 rounded-full h-2 overflow-hidden">
                                        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 h-full rounded-full transition-all duration-1000" style="width: {{ $progressData['completion_rate'] }}%"></div>
                                    </div>
                                    <span class="text-xs font-bold text-gray-500">{{ $progressData['completion_rate'] }}%</span>
                                </div>
                                <p class="text-xs text-gray-500">dari {{ $progressData['total_tryouts_available'] }} tersedia</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                {{-- Average Score Card --}}
                <div class="group relative bg-gradient-to-br from-emerald-50 to-teal-100 backdrop-blur-xl rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-emerald-200/50 overflow-hidden">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-emerald-400 rounded-full blur-3xl opacity-20 group-hover:opacity-30 transition-opacity"></div>
                    <div class="relative">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            @if($stats['average_score'] >= 80)
                                <span class="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-bold flex items-center">
                ...
                {{-- Best Score Card --}}
                <div class="group relative bg-gradient-to-br from-amber-50 to-orange-100 backdrop-blur-xl rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-amber-200/50 overflow-hidden">
                    ...
                    <div class="relative">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            @if($stats['best_score'] >= 90)
                                <span class="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-bold flex items-center">
                                    <i class="fas fa-crown text-yellow-500 mr-1"></i> Top Score
                                </span>
                            @endif
                        </div>
                        <div class="space-y-2">
                            ...
                            <p class="text-sm font-semibold text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-orange-600">
                ...
                {{-- Study Streak Card --}}
                <div class="group relative bg-gradient-to-br from-purple-50 to-pink-100 backdrop-blur-xl rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-purple-200/50 overflow-hidden">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-purple-400 rounded-full blur-3xl opacity-20 group-hover:opacity-30 transition-opacity"></div>
                    <div class="relative">
                        <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-sm font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">
                ...
                <div class="relative overflow-hidden">
                    ...
                    <div class="relative text-center py-20">
                        ...
                        <div class="mb-12 animate-fade-in-up">
                            <div class="inline-flex items-center justify-center w-40 h-40 bg-gradient-to-br from-blue-500 via-purple-500 to-orange-500 rounded-full mb-8 animate-float shadow-2xl">
                                <i class="fas fa-rocket text-7xl text-white transform rotate-45"></i>
                            </div>
                            <h2 class="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-orange-600 mb-6 animate-gradient">
                        ...
                        <div class="relative max-w-4xl mx-auto mb-12 animate-fade-in-up delay-400">
                            <div class="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-600 rounded-3xl blur-lg opacity-50 animate-pulse"></div>
                            <div class="relative bg-gradient-to-r from-blue-600 via-purple-600 to-orange-600 rounded-3xl p-10 text-white shadow-2xl">
                                ...
                                <h3 class="text-4xl font-black mb-4">🚀 Mulai Petualanganmu Sekarang!</h3>
                                <p class="text-xl mb-8 text-white/90">Jangan tunda lagi! Setiap detik yang kamu manfaatkan adalah investasi untuk masa depanmu.</p>
                                ...
                                {{-- Stats Preview --}}
                                <div class="grid grid-cols-3 gap-6 mt-10 pt-8 border-t border-white/30">
                                    <div class="text-center">
                                        <div class="text-3xl font-black mb-2">5000+</div>
                                        <div class="text-sm text-white/80">Soal Tersedia</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-3xl font-black mb-2">1000+</div>
                                        <div class="text-sm text-white/80">Pengguna Aktif</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-3xl font-black mb-2">95%</div>
                        ...
                        {{-- Tips Box with Icon --}}
                        <div class="max-w-2xl mx-auto bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-500 rounded-xl p-6 shadow-lg animate-fade-in-up delay-500">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4 text-left">
                                    <h4 class="text-lg font-bold text-gray-900 mb-2">💡 Tips Pro dari Kami</h4>
                                    <p class="text-gray-700">Mulai dengan tryout kategori <strong>TWK (Tes Wawasan Kebangsaan)</strong> untuk mengukur kemampuan dasarmu. Lalu lanjut ke TIU dan TKP untuk persiapan maksimal!</p>
                                </div>
                            </div>
                        </div>
                    </div>
