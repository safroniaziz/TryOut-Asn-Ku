<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4 -mt-8">
        ...
        <div class="bg-gradient-to-br from-orange-50 to-amber-50">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 -mt-8 relative overflow-hidden">
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-green-50 -mt-8 relative overflow-hidden">
                <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div class="text-center mb-8">
