    ...
    <section class="py-20 bg-gradient-to-br from-blue-50 via-white to-orange-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-6">
                    Lengkap dari <span class="text-gradient">A sampai Z</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                    Semua yang Anda butuhkan untuk sukses CPNS & PPPK dalam satu platform terintegrasi
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-green-300 transition-all duration-300 transform hover:-translate-y-1">
                    <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                ...
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-red-300 transition-all duration-300 transform hover:-translate-y-1">
                    <div class="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                ...
                <!-- Feature 4: Bank Soal Berdasarkan Instansi -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-purple-300 transition-all duration-300 transform hover:-translate-y-1">
                    <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-building text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Soal Berdasarkan Instansi</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Bank soal yang dikategorikan berdasarkan instansi target: Kemenkeu, BPS, BUMN, dan lainnya
                    </p>
                </div>

                <!-- Feature 5: Progress Tracking -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-indigo-300 transition-all duration-300 transform hover:-translate-y-1">
                    <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-chart-line text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Progress Tracking Detail</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Pantau perkembangan belajar dengan grafik kemampuan, weak points, dan target pencapaian harian
                    </p>
                </div>
                ...
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-teal-300 transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-pink-300 transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Aplikasi Mobile</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Belajar kapan saja dengan aplikasi mobile yang sinkron otomatis dengan akun web
                    </p>
                </div>

                <!-- Feature 9: Simulasi CAT -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-yellow-300 transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Simulasi CAT Nyata</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Interface dan pengalaman yang identik dengan sistem CAT BKN untuk adaptasi maksimal
                    </p>
                </div>
            </div>
        </div>
