    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in-up">
                ...
                {{-- Study Streak Card --}}
                <div class="group relative bg-gradient-to-br from-indigo-50 to-purple-100 backdrop-blur-xl rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-indigo-200/50 overflow-hidden">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-indigo-400 rounded-full blur-3xl opacity-20 group-hover:opacity-30 transition-opacity"></div>
                    <div class="relative">
                        <div class="flex items-center justify-between mb-4">
                            <div class="p-3 !bg-indigo-600 rounded-2xl shadow-lg">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-sm font-bold !text-indigo-700 mt-2">
