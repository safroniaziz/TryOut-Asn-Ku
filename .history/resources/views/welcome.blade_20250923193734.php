...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500 bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm" id="navbar">
        ...
        <div id="mobileMenu" class="xl:hidden fixed top-[80px] left-0 right-0 z-[60] bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-xl transform translate-y-[-100%] opacity-0 transition-all duration-300 max-h-[calc(100vh-80px)] overflow-y-auto">
            <div class="max-w-7xl mx-auto px-4 py-6">
                    ...
                    <!-- Navigation Section -->
                    <div class="mb-6">
                        <h4 class="text-xs font-bold text-gray-500 mb-4 text-center px-4">NAVIGASI</h4>
                        <div class="space-y-3">
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        <h4 class="text-xs font-bold text-gray-500 mb-4 text-center px-4">AKUN ANDA</h4>
                        @auth
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleMobileMenu() {
                ...
                const isOpen = mobileMenu.style.transform === 'translateY(0px)' || mobileMenu.style.transform === 'translateY(0)';
