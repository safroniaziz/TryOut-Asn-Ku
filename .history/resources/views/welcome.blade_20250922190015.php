...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500 bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#features" class="nav-item relative px-4 py-2 font-semibold text-gray-700 hover:text-blue-600 transition-colors duration-300">
                        <span>Fitur</span>
                        <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 group-hover:w-full transition-all duration-300"></div>
                    </a>

                    <a href="#pricing" class="nav-item relative px-4 py-2 font-semibold text-gray-700 hover:text-orange-600 transition-colors duration-300">
                        <span>Harga</span>
                        <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></div>
                    </a>

                    <a href="#testimonials" class="nav-item relative px-4 py-2 font-semibold text-gray-700 hover:text-purple-600 transition-colors duration-300">
                        <span>Testimoni</span>
                        <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-600 group-hover:w-full transition-all duration-300"></div>
                    </a>

                    <a href="#contact" class="nav-item relative px-4 py-2 font-semibold text-gray-700 hover:text-green-600 transition-colors duration-300">
                        <span>Kontak</span>
                        <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-green-600 group-hover:w-full transition-all duration-300"></div>
                    </a>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <!-- Mobile Menu Button -->
                    <button id="mobileMenuBtn" class="md:hidden relative p-2 text-gray-700 hover:text-blue-600 transition-all duration-300">
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:scale-105">
                                <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-600 font-semibold transition-colors duration-300 px-4 py-2">
                                Masuk
                            </a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:scale-105">
        ...
        <div id="mobileMenu" class="md:hidden fixed top-20 left-0 right-0 z-40 transform -translate-y-full opacity-0 transition-all duration-300">
            <!-- Background -->
            <div class="bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-xl">
                <div class="max-w-7xl mx-auto px-4 py-6">
                    <!-- Menu Items -->
                    <div class="space-y-4 mb-6">
                        <a href="#features" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-blue-50 transition-all duration-300">
                            <div class="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                                <i class="fas fa-star text-blue-600 text-sm"></i>
                            </div>
                            <span class="font-semibold text-gray-700">Fitur Premium</span>
                        </a>

                        <a href="#pricing" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-orange-50 transition-all duration-300">
                            <div class="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center">
                                <i class="fas fa-gem text-orange-600 text-sm"></i>
                            </div>
                            <span class="font-semibold text-gray-700">Paket Harga</span>
                        </a>

                        <a href="#testimonials" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-purple-50 transition-all duration-300">
                            <div class="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                                <i class="fas fa-heart text-purple-600 text-sm"></i>
                            </div>
                            <span class="font-semibold text-gray-700">Testimoni</span>
                        </a>

                        <a href="#contact" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-green-50 transition-all duration-300">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="col-span-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white p-3 rounded-xl font-semibold text-center">
                                <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 p-3 rounded-xl font-semibold text-center transition-all duration-300">
                                Masuk
                            </a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="bg-gradient-to-r from-orange-500 to-red-500 text-white p-3 rounded-xl font-semibold text-center">
                                    Daftar Gratis
                                </a>
                            @endif
                        @endauth
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-indigo-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    ...
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Unduh materi pembelajaran dan pembahasan detail untuk dipelajari offline kapan saja
                    </p>
                </div>

                <!-- Feature 7 -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-pink-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-tasks text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Multi Tryout per Kategori</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Berbagai variasi tryout TIU, TWK, TKP dengan tingkat kesulitan bertahap
                    </p>
                </div>

                <!-- Feature 8 -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-teal-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-teal-500 to-teal-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                ...
                <!-- Feature 9 -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-yellow-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                ...
                <!-- Feature 10 -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-emerald-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                ...
                <!-- Feature 11 -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-cyan-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-headset text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Support 24/7</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Tim support siap membantu kendala teknis dan pertanyaan seputar platform
                    </p>
                </div>

                <!-- Feature 12 -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-rose-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-rose-500 to-rose-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-trophy text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Ranking & Achievement</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Sistem peringkat nasional dengan leaderboard real-time untuk memotivasi kompetisi sehat
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Kode Promo Diskon -->
                <div class="group bg-white border border-orange-200 rounded-2xl p-8 hover:shadow-xl hover:border-orange-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-tag text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Kode Promo Diskon 5%</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Gunakan kode promo saat mendaftar dan dapatkan diskon 5% dari total pembayaran paket premium
                    </p>
                </div>

                <!-- Referral Program -->
                <div class="group bg-white border border-green-200 rounded-2xl p-8 hover:shadow-xl hover:border-green-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-users text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Program Referral 10%</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Ajak teman daftar dengan kode referral Anda dan dapatkan komisi 10% dari setiap pembayaran mereka
                    </p>
                </div>

                <!-- Money Back Guarantee -->
                <div class="group bg-white border border-blue-200 rounded-2xl p-8 hover:shadow-xl hover:border-blue-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-shield-alt text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Money Back Guarantee</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Jika tidak lulus ujian CPNS/PPPK, kami akan mengembalikan 15% dari total pembayaran Anda
                    </p>
                </div>

                <!-- Group Discount -->
                <div class="group bg-white border border-purple-200 rounded-2xl p-8 hover:shadow-xl hover:border-purple-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-user-friends text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Diskon Grup 10%</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Daftar minimal 3 orang sekaligus dan dapatkan diskon tambahan 10% dari total pembayaran grup
                    </p>
                </div>

                <!-- Live Pembahasan -->
                <div class="group bg-white border border-red-200 rounded-2xl p-8 hover:shadow-xl hover:border-red-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-red-500 to-pink-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fab fa-youtube text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Live Pembahasan YouTube</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Sesi live pembahasan soal 2x seminggu di YouTube dengan mentor berpengalaman dan Q&A interaktif
                    </p>
                </div>

                <!-- Tryout Nasional -->
                <div class="group bg-white border border-yellow-200 rounded-2xl p-8 hover:shadow-xl hover:border-yellow-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-flag text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Tryout Nasional Gratis</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Ikuti tryout nasional gratis dengan peserta se-Indonesia untuk mengukur kemampuan Anda
                    </p>
                </div>

                <!-- Telegram Groups -->
                <div class="group bg-white border border-teal-200 rounded-2xl p-8 hover:shadow-xl hover:border-teal-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fab fa-telegram text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Grup Telegram Eksklusif</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Akses ke grup Telegram public untuk diskusi umum + grup private khusus CASN dan CPPPK terpisah
                    </p>
                </div>

                <!-- Leaderboard per TO -->
                <div class="group bg-white border border-indigo-200 rounded-2xl p-8 hover:shadow-xl hover:border-indigo-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fas fa-chart-line text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Leaderboard per Tryout</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Ranking detail untuk setiap sesi tryout dengan analisis performa dan posisi Anda di tingkat nasional
                    </p>
                </div>

                <!-- Social Media Promotion -->
                <div class="group bg-white border border-pink-200 rounded-2xl p-8 hover:shadow-xl hover:border-pink-300 transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-pink-500 to-rose-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
                        <i class="fab fa-tiktok text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Konten TikTok & YouTube</h3>
                    <p class="text-gray-600 leading-relaxed flex-grow">
                        Dapatkan tips belajar, pembahasan soal viral, dan motivasi harian melalui konten TikTok dan YouTube kami
                    </p>
                </div>
            </div>
        </div>
