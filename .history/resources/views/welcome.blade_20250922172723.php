...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500" id="navbar">
        ...
        <div id="mobileMenu" class="lg:hidden fixed top-0 left-0 w-full h-screen z-40 transform -translate-x-full transition-all duration-500">
            <!-- Animated Background -->
            <div class="absolute inset-0 bg-gradient-to-br from-blue-900/95 via-purple-900/95 to-orange-900/95 backdrop-blur-2xl"></div>
            
            <!-- Floating Particles -->
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                <div class="w-32 h-32 bg-blue-400/10 rounded-full absolute top-20 right-10 animate-pulse"></div>
                <div class="w-24 h-24 bg-purple-400/10 rounded-full absolute bottom-40 left-8 animate-bounce"></div>
                <div class="w-16 h-16 bg-orange-400/10 rounded-full absolute top-1/2 right-1/4 animate-ping"></div>
            </div>

            <div class="relative p-8 pt-28 h-full flex flex-col">
                <!-- Close Button -->
                <button id="mobileMenuClose" class="absolute top-8 right-8 w-12 h-12 bg-white/20 backdrop-blur-xl rounded-2xl flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300">
                ...
                <div class="space-y-8 mb-12">
                    <a href="#features" class="group block text-white hover:text-blue-300 font-bold text-2xl transition-all duration-300 transform hover:translate-x-4">
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300">
                    ...
                    <a href="#pricing" class="group block text-white hover:text-orange-300 font-bold text-2xl transition-all duration-300 transform hover:translate-x-4">
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300">
                    ...
                    <a href="#testimonials" class="group block text-white hover:text-purple-300 font-bold text-2xl transition-all duration-300 transform hover:translate-x-4">
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300">
                    ...
                    <a href="#contact" class="group block text-white hover:text-green-300 font-bold text-2xl transition-all duration-300 transform hover:translate-x-4">
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 bg-gradient-to-r from-green-500 to-teal-500 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300">
                ...
                <div class="space-y-6 mt-auto">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="group block w-full bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 text-white p-6 rounded-2xl font-bold text-xl text-center shadow-2xl transition-all duration-500 hover:scale-105">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="group block w-full bg-white/20 backdrop-blur-xl text-white p-6 rounded-2xl font-bold text-xl text-center border border-white/30 hover:bg-white/30 transition-all duration-300">
                            <div class="flex items-center justify-center space-x-3">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="group block w-full bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 text-white p-6 rounded-2xl font-bold text-xl text-center shadow-2xl transition-all duration-500 hover:scale-105 relative overflow-hidden">
                                ...
                                <div class="absolute bottom-2 left-2 w-2 h-2 bg-yellow-300 rounded-full animate-bounce"></div>
                            </a>
                        @endif
                    @endauth
                </div>
