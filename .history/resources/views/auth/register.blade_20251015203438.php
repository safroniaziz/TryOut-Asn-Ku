    ...
    <div class="max-w-7xl mx-auto w-full px-8 sm:px-12 lg:px-16">
        <div class="flex flex-col lg:flex-row items-center justify-center min-h-screen gap-12 lg:gap-20">
            ...
            <div class="w-full lg:w-2/3 flex items-center justify-center px-4 lg:pl-16 lg:pr-8">
                ...
                <div class="w-full">
                    <!-- Registration Card -->
                    <div class="bg-white rounded-3xl px-12 py-8 shadow-2xl">
                        <!-- Header -->
                        <div class="text-center mb-6">
                            ...
                            <p class="text-gray-600">
                                Mulai perjalanan menuju ASN impianmu
                            </p>

                            <!-- Back to Home Button -->
                            <div class="mt-4">
                                <a href="{{ url('/') }}"
                                   class="group inline-flex items-center space-x-2 bg-gradient-to-r from-gray-50 to-blue-50 hover:from-blue-50 hover:to-blue-100 px-3 py-2 rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-300 shadow-sm hover:shadow-md">
                                    <div class="w-6 h-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-md flex items-center justify-center group-hover:from-blue-600 group-hover:to-blue-700 transition-all duration-300">
                                        <i class="fas fa-arrow-left text-white text-xs"></i>
                                    </div>
                                    <span class="text-gray-700 text-sm font-medium group-hover:text-blue-700 transition-colors duration-300">Kembali ke Halaman Utama</span>
                                </a>
                            </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-6" id="wizardForm">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea id="address" name="address" required rows="3"
                                              class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 placeholder-gray-500 transition-all duration-300 resize-none"
                        ...
                        <div class="wizard-step" id="step4" style="display: none;">
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                                <h4 class="font-medium text-gray-800 mb-3">Ringkasan Data Anda</h4>
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-200">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button" id="prevBtn"
                                    class="flex items-center space-x-2 px-5 py-3 bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-800 rounded-lg transition-all duration-300 font-medium"
                            ...
                            <button type="button" id="nextBtn"
                                    class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-5 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 shadow-md">
...
<script>
    ...
    function updateWizardUI() {
        ...
        for (let i = 1; i <= totalSteps; i++) {
            ...
            if (i <= currentStep) {
                stepIndicator.className = 'w-10 h-10 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-semibold';
            } else {
