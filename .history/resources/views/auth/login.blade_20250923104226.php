...
<head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
...
<body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 font-inter">    <title>Masuk - TryOut ASNku</title>    <meta charset="utf-8">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative">
            ...
            <div class="w-full bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-12">    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}"><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                ...
                <div class="max-w-md text-white">
                    ...
                    <div class="text-center mb-8">    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
                        ...
                        <div class="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-4">
                            ...
                            <i class="fas fa-graduation-cap text-blue-600 text-2xl"></i>    @vite(['resources/css/app.css', 'resources/js/app.js'])    <meta name="csrf-token" content="{{ csrf_token() }}">
                    ...
                    </div><body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 font-['Inter']">    <meta charset="utf-8">
                    ...
                    <div class="text-center mb-8">    <div class="min-h-screen flex">
                        ...
                        <p class="text-blue-100">Lanjutkan persiapan ASN terbaikmu</p>        <!-- Left Side - Branding -->    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-3">            <div class="w-full bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-12">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><head>

                            <div class="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center">

                                <i class="fas fa-check text-white text-sm"></i>                <div class="max-w-md text-white">
                        ...
                        <div class="flex items-center space-x-3">                        <div class="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-4">
                            ...
                            <div class="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">
                                ...
                                <i class="fas fa-chart-line text-white text-sm"></i>                            <i class="fas fa-graduation-cap text-blue-600 text-2xl"></i>    <link rel="preconnect" href="https://fonts.googleapis.com">    <meta name="csrf-token" content="{{ csrf_token() }}">

                            </div>

                            <span>Analisis Mendalam</span>                        </div>
                        ...
                        <div class="flex items-center space-x-3">                        <h1 class="text-3xl font-bold mb-2">TryOut ASNku</h1>    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
                            ...
                            <div class="w-8 h-8 bg-purple-500 rounded-lg flex items-center justify-center">
                                ...
                                <i class="fas fa-users text-white text-sm"></i>                        <p class="text-blue-100">Platform Persiapan ASN Terdepan</p>

                            </div>

                            <span>Komunitas Elite</span>                    </div>    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">    <meta charset="utf-8">    <meta charset="utf-8">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">                        <p class="text-blue-100">Lanjutkan persiapan ASN terbaikmu</p>    <!-- Icons -->    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8">                    </div>
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Masuk Akun</h3>                        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
