...
<div class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    <div class="max-w-7xl mx-auto w-full px-8 sm:px-12 lg:px-16">
        <div class="flex flex-col lg:flex-row items-center justify-center min-h-screen gap-6 lg:gap-8">

            <!-- Left Side - Informative Branding -->
            <div class="hidden lg:flex lg:w-1/2 flex-col justify-center pr-4 pl-4">
            ...
            <div class="w-full lg:w-1/2 flex items-center justify-center px-4 lg:pl-4 lg:pr-4">
                <!-- Mobile Logo -->
                ...
                <div class="w-full max-w-xl mx-auto">
                    <!-- Registration Card -->
                    <div class="bg-white rounded-3xl px-7 py-6 shadow-2xl">
                        <!-- Header -->
...
<script>
    ...
    function addStepClickListeners() {
        ...
        if (currentStep < totalSteps) {
            ...
            logRegistrationStep(currentStep);
    ...
    function prevStep() {
        if (currentStep > 1) {
            ...
            // Log step navigation
            logRegistrationStep(currentStep, 'back');
    ...
    // Log registration step progress
    function logRegistrationStep(step, direction = 'forward') {
        ...
        fetch('/api/log-registration-step', {
            method: 'POST',
            headers: {
            ...
            console.error('Log registration step error:', error);
        });
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // University field toggle now handled by Select2 events above
        ...
        .then(data => {
            if (data.success) {
                ...
                if (data.already_verified) {
                    // Nomor sudah diverifikasi sebelumnya
                    Swal.fire({
                        icon: 'success',
                        ...
                        // Auto mark as verified and proceed
                        window.phoneVerified = true;
                        nextStep();
                    });
                } else if (data.reuse_existing) {
                    // Ada OTP yang masih valid
                    Swal.fire({
                        icon: 'info',
                        title: '📱 OTP Masih Berlaku',
                        html: `
                            <p class="text-gray-600 mb-4">${data.message}</p>
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                <p class="text-blue-700 text-sm">
                                    <i class="fas fa-clock mr-2"></i>
                                    Silakan cek WhatsApp Anda untuk kode yang sudah dikirim
                                </p>
                            </div>
                        `,
...
<style>
    ...
    /* Select2 text alignment - high specificity to override defaults */
    .select2-container--default .select2-selection--single .select2-selection__rendered,
    .select2-container--default .select2-selection--single .select2-selection__placeholder {
        color: rgb(17 24 39) !important;
        padding-left: 1rem !important; /* Same as input px-4 */
        ...
        left: 0 !important; /* Force no left positioning */
        position: static !important; /* Remove any absolute positioning */
    }

    /* Additional reset for any Select2 default positioning */
    .select2-container * {
    ...
    /* Force consistent alignment even after reinitialize */
    ...
    .select2-container--default.select2-container--open .select2-selection__arrow b {
        border-color: transparent transparent rgb(107 114 128) transparent !important;
    ...
    .select2-search__field {
        ...
        padding: 0.5rem 0.5rem 0.5rem 2.5rem !important; /* Left padding untuk icon search */
    ...
    /* Custom styling untuk dropdown search container */
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Force consistent alignment on initial load
        setTimeout(function() {
        ...
        // Event listener untuk memastikan alignment konsisten
        $(document).on('select2:open select2:close select2:select select2:unselect', function() {
            setTimeout(function() {
                $('.select2-selection__rendered, .select2-selection__placeholder').css({
                    'padding-left': '1rem',
                    'margin-left': '0',
        ...
        // Also add standard event listener for non-Select2 education level dropdown
        ...
        $('form').on('reset', function() {
            setTimeout(function() {
                ...
                // Force consistent alignment after reset
                setTimeout(function() {
                    $('.select2-selection__rendered, .select2-selection__placeholder').css({
                        'padding-left': '1rem',
                        'margin-left': '0',
    ...
    function updateCitiesSelect2(selectedProvince) {
        ...
        // Force consistent alignment after reinitialize
        setTimeout(function() {
            $('.select2-selection__rendered, .select2-selection__placeholder').css({
                'padding-left': '1rem',
                'margin-left': '0',
