...
<head><head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>
    ...
    <style>    <style>
        ...
        .auth-bg::before {            position: relative;

            content: '';        }

            position: absolute;

            top: 0;        /* Premium Background */
            ...
            background-image:             top: 0;
                ...
                radial-gradient(circle at 25% 25%, rgba(255, 255, 255, 0.1) 0%, transparent 50%),            left: 0;

                radial-gradient(circle at 75% 75%, rgba(255, 255, 255, 0.1) 0%, transparent 50%);            right: 0;

            animation: subtle-float 8s ease-in-out infinite alternate;            bottom: 0;

        }            background-image: 

                radial-gradient(circle at 25% 25%, rgba(255, 255, 255, 0.1) 0%, transparent 50%),

        @keyframes subtle-float {                radial-gradient(circle at 75% 75%, rgba(255, 255, 255, 0.1) 0%, transparent 50%);

            0%, 100% { transform: translateY(0px); }            animation: float 6s ease-in-out infinite;
        ...
        .glass-card {            0%, 100% { transform: translateY(0px); }

            background: rgba(255, 255, 255, 0.95);            50% { transform: translateY(-20px); }

            backdrop-filter: blur(25px);        }

            border: 1px solid rgba(255, 255, 255, 0.3);

            box-shadow:         /* Premium Glass Card */

                0 25px 50px -12px rgba(0, 0, 0, 0.25),        .glass-card {
        ...
        .brand-card {                0 25px 50px -12px rgba(0, 0, 0, 0.25),
            ...
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.15) 0%, rgba(255, 255, 255, 0.05) 100%);                0 0 0 1px rgba(255, 255, 255, 0.05),

            backdrop-filter: blur(25px);                inset 0 1px 0 rgba(255, 255, 255, 0.1);
            ...
            box-shadow:         }
                ...
                inset 0 1px 0 rgba(255, 255, 255, 0.1);        .glass-card:hover {

            border-radius: 24px;            transform: translateY(-5px);

        }            box-shadow: 

                0 35px 70px -12px rgba(0, 0, 0, 0.3),

        .premium-input {                0 0 0 1px rgba(255, 255, 255, 0.1),

            background: rgba(255, 255, 255, 0.95);                inset 0 1px 0 rgba(255, 255, 255, 0.2);
        ...
        .premium-input:focus {            border-radius: 16px;

            outline: none;            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);

            border-color: #667eea;            font-family: 'Inter', sans-serif;
            ...
            box-shadow:         }
                ...
                0 10px 25px rgba(102, 126, 234, 0.15);        .premium-input:focus {
        ...
        .premium-btn {            box-shadow: 

            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);                0 0 0 4px rgba(102, 126, 234, 0.1),

            border: none;                0 10px 20px rgba(102, 126, 234, 0.15);

            border-radius: 16px;            transform: translateY(-2px);

            color: white;        }

            font-family: 'Space Grotesk', sans-serif;

            font-weight: 600;        .premium-input::placeholder {
        ...
        .premium-btn::before {        .btn-spectacular {
            ...
            content: '';            background: linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%);

            position: absolute;            border: none;

            top: 0;            border-radius: 16px;

            left: -100%;            color: white;

            width: 100%;            font-family: 'Sora', sans-serif;

            height: 100%;            font-weight: 700;

            background: linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.2), transparent);            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
        ...
        .premium-btn:hover {                0 10px 20px rgba(102, 126, 234, 0.3),

            transform: translateY(-2px);                0 0 0 1px rgba(255, 255, 255, 0.1) inset;

            box-shadow:         }

                0 15px 35px rgba(102, 126, 234, 0.4),

                0 5px 15px rgba(0, 0, 0, 0.1);        .btn-spectacular::before {

        }            content: '';

            position: absolute;

        .premium-btn:hover::before {            top: 0;
        ...
        .gradient-text {            background: linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.2), transparent);
            ...
            -webkit-text-fill-color: transparent;        .btn-spectacular:hover {

            font-weight: 800;            transform: translateY(-3px) scale(1.02);
        ...
        .icon-premium {                0 0 0 1px rgba(255, 255, 255, 0.2) inset;
            ...
            box-shadow: 
                ...
                0 10px 25px rgba(102, 126, 234, 0.3),        .btn-spectacular:hover::before {

                0 0 0 1px rgba(255, 255, 255, 0.1) inset;            left: 100%;
        ...
        @keyframes premium-glow {            transform: translateY(-1px) scale(1.01);

            from {        }

                box-shadow: 

                    0 10px 25px rgba(102, 126, 234, 0.3),        /* Elegant Text */

                    0 0 0 1px rgba(255, 255, 255, 0.1) inset;        .gradient-text {

            }            background: linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%);

            to {            background-clip: text;

                box-shadow:             -webkit-background-clip: text;

                    0 15px 35px rgba(102, 126, 234, 0.5),            -webkit-text-fill-color: transparent;

                    0 0 0 1px rgba(255, 255, 255, 0.2) inset;            font-family: 'Sora', sans-serif;
        ...
        .feature-card {        /* Brand Card */
            ...
            background: rgba(255, 255, 255, 0.1);        .brand-card {

            border: 1px solid rgba(255, 255, 255, 0.2);            background: linear-gradient(135deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.05) 100%);

            border-radius: 16px;            backdrop-filter: blur(20px);

            backdrop-filter: blur(10px);            border: 1px solid rgba(255, 255, 255, 0.2);

            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);            border-radius: 24px;
        ...
        .feature-card:hover {        }
            ...
            box-shadow: 0 20px 40px rgba(0, 0, 0, 0.1);            transform: translateY(-3px);
        ...
        .stats-number {
            ...
            font-family: 'Space Grotesk', sans-serif;        /* Icon Glow */

            font-weight: 700;        .icon-elegant {

            background: linear-gradient(135deg, #FFD700 0%, #FFA500 100%);            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);

            background-clip: text;            filter: drop-shadow(0 4px 8px rgba(102, 126, 234, 0.3));
        ...
        .floating-element {            filter: drop-shadow(0 8px 16px rgba(102, 126, 234, 0.4));

            position: absolute;        }

            border-radius: 50%;

            background: rgba(255, 255, 255, 0.1);        /* Feature Cards */

            animation: float-gentle 6s ease-in-out infinite;        .feature-card {

        }            background: linear-gradient(135deg, rgba(255, 255, 255, 0.15) 0%, rgba(255, 255, 255, 0.1) 100%);

            border: 1px solid rgba(255, 255, 255, 0.2);

        @keyframes float-gentle {            border-radius: 20px;

            0%, 100% { transform: translateY(0px) rotate(0deg); }            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);

            50% { transform: translateY(-15px) rotate(180deg); }            backdrop-filter: blur(10px);
        ...
        @media (max-width: 768px) {            transform: translateX(8px) translateY(-2px);

            .auth-bg {            background: linear-gradient(135deg, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0.15) 100%);

                padding: 1rem;            box-shadow: 0 15px 30px rgba(0, 0, 0, 0.1);

            }        }

            

            .glass-card, .brand-card {        /* Link Styles */

                border-radius: 20px;        .link-elegant {

                padding: 1.5rem;            color: #667eea;
