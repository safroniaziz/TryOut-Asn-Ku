    ...
    <div class="relative z-10 min-h-screen flex w-full">
        ...
        <div class="hidden lg:flex lg:w-1/2 flex-col justify-center px-16 relative">
            ...
            <div class="text-gray-800 space-y-8">
                <!-- Logo -->
                <div class="relative">
                    <h1 class="text-6xl font-black mb-4 text-gray-900">
                        TryOut<span class="text-blue-600">ASN</span>ku
                    </h1>
                </div>

                <div class="space-y-6">
                    <p class="text-xl font-light text-gray-600 leading-relaxed">
                        Platform persiapan <span class="font-bold text-blue-600">CPNS & PPPK</span> terpercaya
                    </p>
                    ...
                    <div class="space-y-4 mt-8">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <div class="text-gray-800 font-semibold">Bank Soal Lengkap</div>
                                <div class="text-gray-600 text-sm">Ribuan soal berkualitas</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <div class="text-gray-800 font-semibold">Analisis Hasil</div>
                                <div class="text-gray-600 text-sm">Laporan pembelajaran detail</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <div class="text-gray-800 font-semibold">Komunitas Belajar</div>
                                <div class="text-gray-600 text-sm">Belajar bersama ribuan member</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center px-8 py-12 relative">
            ...
            <div class="lg:hidden absolute top-8 left-1/2 transform -translate-x-1/2 text-center">
                <h1 class="text-3xl font-black text-gray-800 mb-2">TryOut ASNku</h1>
            </div>
