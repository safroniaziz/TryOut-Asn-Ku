                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-4">
                            ...
                            <div class="space-y-2">
                                <label for="work_status" class="block text-sm font-semibold text-gray-700">
                                    Status Pekerjaan Saat Ini <span class="text-red-500">*</span>
                                </label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    ...
                                    <select id="work_status"
                                            name="work_status"
                                            required
                                            class="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300">
                                        ...
                                        <option value="swasta" {{ old('work_status') == 'swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="target_score"
                                           ...
                                           min="100"
                                           max="500"
                                           placeholder="contoh: 400 (opsional)"
                                ...
                                <p class="text-xs text-gray-500">Skor target yang ingin Anda capai (100-500)</p>
                            </div>

                            <!-- Referral Code Field (Optional) -->
                            <div class="space-y-2">
                                <label for="used_referral_code" class="block text-sm font-semibold text-gray-700">
                                    Kode Referral <span class="text-xs text-gray-500">(Opsional)</span>
                                </label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    ...
                                    <input id="used_referral_code"
                                           ...
                                           class="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 uppercase">
