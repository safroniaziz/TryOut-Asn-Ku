            ...
            <div class="hidden lg:flex lg:w-1/3 flex-col justify-center pr-8">
                <div class="text-white space-y-6">
                    ...
                    <div class="grid grid-cols-3 gap-4 pt-4 border-t border-white/20">
                        ...
                        <!-- Enhanced Navigation Buttons (moved below form) -->
                        ...
                        <!-- WIZARD NAVIGATION BUTTONS (ALWAYS VISIBLE) - MOVED BELOW FORM -->
                        <div class="fixed-navigation-buttons bg-white p-4 rounded-lg border-2 border-blue-200 mt-6 shadow-md">
                            <div class="flex items-center justify-between">
