...
<div class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    <div class="max-w-7xl mx-auto w-full px-8 sm:px-12 lg:px-16">
        <div class="flex flex-col lg:flex-row items-center justify-center min-h-screen gap-8 lg:gap-12">

            <!-- Left Side - Informative Branding -->
            <div class="hidden lg:flex lg:w-1/2 flex-col justify-center pr-6 pl-4">
            ...
            <div class="w-full lg:w-1/2 flex items-center justify-center px-4 lg:pl-6 lg:pr-4">
                <!-- Mobile Logo -->
                ...
                <div class="w-full max-w-3xl mx-auto">
                    <!-- Registration Card -->
                    <div class="bg-white rounded-3xl px-20 py-8 shadow-2xl w-full">
                        <!-- Header -->
