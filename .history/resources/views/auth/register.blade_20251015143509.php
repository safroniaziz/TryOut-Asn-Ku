...
<script>
    ...
    function initWizard() {
        ...
        // Add visual feedback to confirm wizard is working
        showNotification('🎉 Wizard initialized! Ready to start registration', 'success');

        // Add debug class to body temporarily
        document.body.classList.add('debug-mode');
        setTimeout(() => {
            document.body.classList.remove('debug-mode');
        }, 3000);

        // Add click test for next button
        setTimeout(() => {
            const testElement = document.createElement('div');
            testElement.innerHTML = '🎯 Click "Lanjutkan" button to proceed';
            testElement.className = 'fixed top-4 left-4 bg-yellow-100 border border-yellow-400 text-yellow-800 px-4 py-2 rounded-lg text-sm font-medium z-50';
