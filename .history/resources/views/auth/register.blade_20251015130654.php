        ...
        <div class="flex flex-col lg:flex-row items-center justify-center min-h-screen">
            ...
            <div class="w-full lg:w-1/2 flex items-center justify-center">
                ...
                <div class="w-full max-w-md">
                    <!-- Register Card -->
                    <div class="bg-white rounded-2xl p-6 shadow-2xl register-form">
                        <!-- Header -->
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-3">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="education_level"
                                                ...
                                                required
                                                class="w-full pl-9 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 text-sm">
                                ...
                                <!-- Work Status Field -->
                                <div class="space-y-1">
                                    <label for="work_status" class="block text-sm font-medium text-gray-700">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <!-- Target Score Field -->
                                <div class="space-y-1">
                                    <label for="target_score" class="block text-sm font-medium text-gray-700">
                                        Target Skor
                                    </label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        ...
                                        <input id="target_score"
                                               ...
                                               class="w-full pl-9 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 text-sm">
                                        @error('target_score')
                                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="space-y-1">
                                    <label for="used_referral_code" class="block text-sm font-medium text-gray-700">
                                        Kode Referral
                                    </label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        ...
                                        <input id="used_referral_code"
                                               ...
                                               class="w-full pl-9 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 text-sm uppercase">
                            ...
                            <!-- Register Button -->
                            <button type="submit"
                                    class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-[1.02]">
