                    ...
                    <div class="bg-white rounded-2xl px-6 py-8 shadow-2xl register-form">
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button type="button" 
                                        id="prevBtn"
                                        class="group flex items-center space-x-2 px-6 py-3 bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-600 hover:text-gray-700 rounded-xl transition-all duration-300 text-sm font-semibold shadow-sm hover:shadow-md"
                                ...
                                <button type="button" 
                                        id="nextBtn"
                                        class="group relative flex items-center space-x-3 bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 text-sm min-w-[140px]">
                                    ...
                                    <span id="nextBtnText" class="relative z-10">Lanjutkan</span>
                                    <i class="fas fa-arrow-right text-sm relative z-10 group-hover:translate-x-1 transition-transform" id="nextBtnIcon"></i>
                                    
                                    <!-- Loading spinner (hidden by default) -->
                                    <div class="absolute inset-0 flex items-center justify-center" id="btnLoading" style="display: none;">
    ...
    function updateWizardUI() {
        ...
        document.querySelectorAll('.step-indicator').forEach((indicator, index) => {
            ...
            if (stepNumber <= currentStep) {
                circle.className = 'w-10 h-10 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-semibold shadow-lg';
        ...
        if (currentStep === totalSteps) {
            ...
            nextBtnIcon.className = 'fas fa-rocket text-xs';
        } else {
            nextBtnText.textContent = 'Lanjutkan';
            nextBtnIcon.className = 'fas fa-arrow-right text-xs';
        }
    }
