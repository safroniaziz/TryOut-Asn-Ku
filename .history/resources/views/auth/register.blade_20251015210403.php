...
<script>
    // Province-City Data (comprehensive)
    const cityData = {
        'DKI Jakarta': ['Jakarta Pusat', 'Jakarta Utara', 'Jakarta Barat', 'Jakarta Selatan', 'Jakarta Timur', 'Kepulauan Seribu'],
        'Jawa Barat': ['Bandung', 'Bekasi', 'Bogor', 'Depok', 'Cimahi', 'Sukabumi', 'Cirebon', 'Tasikmalaya', 'Banjar', 'Karawang', 'Purwakarta', 'Subang', 'Indramayu', 'Sumedang', 'Kuningan', 'Majalengka', 'Cianjur', 'Garut', 'Ciamis', 'Pangandaran'],
        'Jawa Tengah': ['Semarang', 'Surakarta', 'Magelang', 'Salatiga', 'Pekalongan', 'Tegal', 'Yogyakarta', 'Klaten', 'Boyolali', 'Wonogiri', 'Karanganyar', 'Sragen', 'Grobogan', 'Blora', 'Rembang', 'Pati', 'Kudus', 'Jepara', 'Demak', 'Temanggung', 'Wonosobo', 'Kendal', 'Batang', 'Pekalongan', 'Pemalang', 'Tegal', 'Brebes', 'Cilacap', 'Banyumas', 'Purbalingga', 'Banjarnegara', 'Kebumen', 'Purworejo'],
        'Jawa Timur': ['Surabaya', 'Malang', 'Kediri', 'Blitar', 'Mojokerto', 'Madiun', 'Pasuruan', 'Probolinggo', 'Batu', 'Gresik', 'Sidoarjo', 'Lamongan', 'Tuban', 'Bojonegoro', 'Ngawi', 'Magetan', 'Ponorogo', 'Pacitan', 'Trenggalek', 'Tulungagung', 'Jombang', 'Nganjuk', 'Lumajang', 'Jember', 'Banyuwangi', 'Bondowoso', 'Situbondo', 'Pamekasan', 'Sampang', 'Bangkalan', 'Sumenep'],
        'Banten': ['Tangerang', 'Tangerang Selatan', 'Cilegon', 'Serang', 'Pandeglang', 'Lebak'],
        'Sumatera Utara': ['Medan', 'Binjai', 'Tebing Tinggi', 'Pematangsiantar', 'Tanjungbalai', 'Sibolga', 'Padangsidimpuan', 'Gunungsitoli', 'Deli Serdang', 'Langkat', 'Karo', 'Simalungun', 'Asahan', 'Labuhanbatu', 'Dairi', 'Toba Samosir', 'Mandailing Natal', 'Tapanuli Selatan', 'Tapanuli Tengah', 'Tapanuli Utara', 'Humbang Hasundutan', 'Pakpak Bharat', 'Samosir', 'Serdang Bedagai', 'Batu Bara', 'Padang Lawas Utara', 'Padang Lawas', 'Labuhanbatu Selatan', 'Labuhanbatu Utara', 'Nias', 'Nias Selatan', 'Nias Utara', 'Nias Barat'],
        'Sumatera Barat': ['Padang', 'Bukittinggi', 'Padangpanjang', 'Payakumbuh', 'Sawahlunto', 'Solok', 'Pariaman', 'Agam', 'Lima Puluh Kota', 'Pasaman', 'Solok Selatan', 'Dharmasraya', 'Sijunjung', 'Tanah Datar', 'Padang Pariaman', 'Pesisir Selatan', 'Kepulauan Mentawai', 'Pasaman Barat'],
        'Sumatera Selatan': ['Palembang', 'Prabumulih', 'Pagar Alam', 'Lubuklinggau', 'Ogan Komering Ulu', 'Ogan Komering Ilir', 'Muara Enim', 'Lahat', 'Musi Rawas', 'Musi Banyuasin', 'Banyuasin', 'Ogan Komering Ulu Selatan', 'Ogan Komering Ulu Timur', 'Ogan Ilir', 'Empat Lawang', 'Penukal Abab Lematang Ilir', 'Musi Rawas Utara'],
        ...
        'Kalimantan Utara': ['Tarakan', 'Malinau', 'Bulungan', 'Nunukan', 'Tana Tidung'],
