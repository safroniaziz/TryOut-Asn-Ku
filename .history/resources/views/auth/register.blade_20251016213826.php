...
<div class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    <div class="max-w-8xl mx-auto w-full px-6 sm:px-8 lg:px-12">
        <div class="flex flex-col lg:flex-row items-center justify-center min-h-screen gap-12 lg:gap-20">
            ...
            <div class="hidden lg:flex lg:w-2/5 flex-col justify-center pr-8 pl-4">
            ...
            <div class="w-full lg:w-3/5 flex items-center justify-center px-4 lg:pl-8 lg:pr-4">
                <!-- Mobile Logo -->
                ...
                <div class="w-full max-w-2xl mx-auto">
                    <!-- Registration Card -->
                    <div class="bg-white rounded-3xl px-16 py-6 shadow-2xl">
                        <!-- Header -->
