...
<head>
    ...
    <style>
        ...
        .bg-gradient-to-r.from-green-50.to-emerald-50:hover {
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-6">
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                        <select name="experience_level" required 
                                            ...
                                            <option value="beginner" {{ old('experience_level') == 'beginner' ? 'selected' : '' }}>Pertama kali ikut tes</option>
                                            <option value="intermediate" {{ old('experience_level') == 'intermediate' ? 'selected' : '' }}>Sudah pernah 1-2x</option>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <label for="terms" class="text-sm text-gray-600">
                                        ...
                                        dan <a href="#" class="text-blue-600 hover:underline font-semibold">Kebijakan Privasi</a>
                                    </label>
                                </div>
                            ...
                            <div class="text-center">
                                <p class="text-gray-600">
                                    Sudah punya akun? 
                                    <a href="{{ route('login') }}" class="gradient-text font-bold hover:underline">
                                        Masuk di sini
                                    </a>
                                </p>
                            </div>
