...
<div class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    <div class="max-w-7xl mx-auto w-full px-6 sm:px-8 lg:px-12">
        <div class="flex flex-col lg:flex-row items-center justify-center min-h-screen gap-8 lg:gap-12">
            ...
            <div class="hidden lg:flex lg:w-1/3 flex-col justify-center pr-12 pl-6">
            ...
            <div class="w-full lg:w-2/3 flex items-center justify-center px-4 lg:pl-12 lg:pr-6">
                <!-- Mobile Logo -->
