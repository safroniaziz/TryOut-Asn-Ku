        ...
        <div class="max-w-6xl mx-auto w-full flex items-center">
            ...
            <div class="hidden lg:flex lg:w-1/2 flex-col justify-center pr-12">
                ...
                <div class="text-white space-y-8">
                    <!-- Logo -->
                    <div class="relative">
                        <h1 class="text-7xl font-black mb-6 text-white">
                            TryOut<span class="text-orange-400">ASN</span>ku
                        </h1>
                        <p class="text-xl font-light text-blue-100 leading-relaxed mb-8">
                            Platform persiapan <span class="font-bold text-orange-300">CPNS & PPPK</span> terlengkap di Indonesia
                        </p>
                    </div>
