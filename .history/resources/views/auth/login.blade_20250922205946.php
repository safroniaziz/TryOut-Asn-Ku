        ...
        <div class="max-w-6xl w-full">
            <div class="grid lg:grid-cols-5 gap-8 items-center">
                ...
                <div class="lg:col-span-2 fade-in">
                    <div class="brand-card p-8 text-white">
                        <!-- Logo Section -->
                        <div class="text-center mb-8">
                            <div class="w-20 h-20 bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-4 icon-elegant shadow-2xl">
                                <i class="fas fa-graduation-cap text-white text-3xl"></i>
                            </div>
                            <h1 class="text-3xl font-black text-white mb-2">
                                TryOut ASNku
                            </h1>
                            <p class="text-blue-200 text-sm font-medium">Platform Persiapan ASN Terpercaya</p>
                        </div>

                        <div class="text-center mb-8">
                            <h2 class="text-2xl md:text-3xl font-black mb-4 leading-tight text-white">
                                Selamat Datang 
                                <span class="bg-gradient-to-r from-yellow-300 to-orange-400 bg-clip-text text-transparent">Kembali!</span>
                            </h2>
                            <p class="text-blue-100 leading-relaxed">
                                Lanjutkan persiapan ASN impianmu dengan 
                                <strong class="text-yellow-300">50,000+ soal premium</strong> dan analisis mendalam.
                            </p>
                        </div>

                        <!-- Elegant Features -->
                        <div class="space-y-4">
                            <div class="feature-card p-4 slide-in">
                                <div class="flex items-center space-x-4">
                                    <div class="w-12 h-12 bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl flex items-center justify-center icon-elegant">
                                        <i class="fas fa-check text-white"></i>
                                    </div>
                                    <div>
                                        <h4 class="font-bold text-white">Akses Unlimited</h4>
                                        <p class="text-blue-200 text-sm">Semua paket soal premium</p>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="feature-card p-4 slide-in" style="animation-delay: 0.1s">
                                <div class="flex items-center space-x-4">
                                    <div class="w-12 h-12 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-xl flex items-center justify-center icon-elegant">
                                        <i class="fas fa-chart-line text-white"></i>
                                    </div>
                                    <div>
                                        <h4 class="font-bold text-white">Progress Tracking</h4>
                                        <p class="text-blue-200 text-sm">Analisis performa real-time</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="feature-card p-4 slide-in" style="animation-delay: 0.2s">
                                <div class="flex items-center space-x-4">
                                    <div class="w-12 h-12 bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl flex items-center justify-center icon-elegant">
                                        <i class="fas fa-users text-white"></i>
                                    </div>
                                    <div>
                                        <h4 class="font-bold text-white">Komunitas Expert</h4>
                                        <p class="text-purple-200 text-sm">Diskusi & tips dari mentor</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-3 fade-in" style="animation-delay: 0.3s">
                    <div class="glass-card p-8">
                        <!-- Header -->
                        <div class="text-center mb-8">
                            <div class="w-16 h-16 bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-500 rounded-2xl flex items-center justify-center mx-auto mb-4 icon-elegant shadow-2xl">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="link-elegant text-sm" href="{{ route('password.request') }}">
                                        Lupa password?
                                    </a>
                                @endif
                            </div>
                            ...
                            <!-- Login Button -->
                            <button type="submit" 
                                    class="btn-spectacular w-full py-4 px-6 text-white font-bold text-lg">
