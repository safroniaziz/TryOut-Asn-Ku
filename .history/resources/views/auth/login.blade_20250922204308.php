...
<head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}"><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">    <meta name="csrf-token" content="{{ csrf_token() }}">    <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <!-- Icons -->    <title>{{ config('app.name', 'Laravel') }} - Masuk ke Akun</title>    <title>{{ config('app.name', 'Laravel') }} - Masuk ke Akun</title>
    ...
    <style>    <style>
        ...
        .auth-bg::before {
            ...
            animation: float 6s ease-in-out infinite;        .auth-bg {        .auth-bg {
        ...
        .auth-bg::after {
            ...
            bottom: -150px;            min-height: 100vh;            min-height: 100vh;

            left: -150px;

            animation: float 8s ease-in-out infinite reverse;            position: relative;            position: relative;
        ...
        .brand-card {
            ...
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.05) 100%);            content: '';            content: '';
        ...
        .spectacular-input {            height: 300px;            height: 300px;

            background: rgba(255, 255, 255, 0.9);

            border: 2px solid rgba(102, 126, 234, 0.2);            border-radius: 50%;            border-radius: 50%;

            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);

            position: relative;            background: rgba(255, 255, 255, 0.1);            background: rgba(255, 255, 255, 0.1);
        ...
        .spectacular-input:focus {
            ...
            background: rgba(255, 255, 255, 1);        .auth-bg::before {        .auth-bg::before {
        ...
        .btn-spectacular {            right: -150px;            right: -150px;

            background: linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%);

            box-shadow:             animation: float 6s ease-in-out infinite;            animation: float 6s ease-in-out infinite;
        ...
        .btn-spectacular:hover {            bottom: -150px;            bottom: -150px;

            transform: translateY(-2px);

            box-shadow:             left: -150px;            left: -150px;

                0 15px 30px rgba(102, 126, 234, 0.4),

                0 0 0 1px rgba(255, 255, 255, 0.2) inset;            animation: float 8s ease-in-out infinite reverse;            animation: float 8s ease-in-out infinite reverse;
        ...
        .btn-spectacular::before {
            ...
            top: 0;        .glass-card {        .glass-card {

            left: -100%;

            width: 100%;            background: rgba(255, 255, 255, 0.95);            background: rgba(255, 255, 255, 0.95);

            height: 100%;

            background: linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.2), transparent);            backdrop-filter: blur(20px);            backdrop-filter: blur(20px);
        ...
        .btn-spectacular:hover::before {            box-shadow:             box-shadow: 
        ...
        .gradient-text {                0 0 0 1px rgba(255, 255, 255, 0.05),                0 0 0 1px rgba(255, 255, 255, 0.05),

            background: linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%);

            background-clip: text;                inset 0 1px 0 rgba(255, 255, 255, 0.1);                inset 0 1px 0 rgba(255, 255, 255, 0.1);
        ...
        .icon-glow {        .brand-card {        .brand-card {
        ...
        @keyframes iconGlow {            backdrop-filter: blur(20px);            backdrop-filter: blur(20px);
            ...
            from {
                ...
                box-shadow:             border: 1px solid rgba(255, 255, 255, 0.2);            border: 1px solid rgba(255, 255, 255, 0.2);
                    ...
                    0 0 40px rgba(102, 126, 234, 0.4),            box-shadow: 0 20px 40px rgba(0, 0, 0, 0.1);            box-shadow: 0 20px 40px rgba(0, 0, 0, 0.1);
            ...
            to {
                ...
                box-shadow: 
                    ...
                    0 0 60px rgba(118, 75, 162, 0.6),        .spectacular-input {        .spectacular-input {
        ...
        .feature-highlight {
            ...
            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
        ...
        .feature-highlight:hover {
            ...
            border-radius: 12px;        .spectacular-input:focus {        .spectacular-input:focus {
