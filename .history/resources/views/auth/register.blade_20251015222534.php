                            ...
                            <div class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select id="university" name="university"
                                        ...
                                        <!-- Universitas Negeri Terpopuler -->
                                        <option value="Universitas Gadjah Mada" {{ old('university') == 'Universitas Gadjah Mada' ? 'selected' : '' }}>Universitas Gadjah Mada</option>
                                        <option value="Universitas Indonesia" {{ old('university') == 'Universitas Indonesia' ? 'selected' : '' }}>Universitas Indonesia</option>
                                        <option value="Institut Teknologi Bandung" {{ old('university') == 'Institut Teknologi Bandung' ? 'selected' : '' }}>Institut Teknologi Bandung</option>
                                        <option value="Institut Pertanian Bogor" {{ old('university') == 'Institut Pertanian Bogor' ? 'selected' : '' }}>Institut Pertanian Bogor</option>
                                        <option value="Universitas Diponegoro" {{ old('university') == 'Universitas Diponegoro' ? 'selected' : '' }}>Universitas Diponegoro</option>
                                        <option value="Universitas Airlangga" {{ old('university') == 'Universitas Airlangga' ? 'selected' : '' }}>Universitas Airlangga</option>
                                        <option value="Universitas Brawijaya" {{ old('university') == 'Universitas Brawijaya' ? 'selected' : '' }}>Universitas Brawijaya</option>
                                        <option value="Universitas Padjadjaran" {{ old('university') == 'Universitas Padjadjaran' ? 'selected' : '' }}>Universitas Padjadjaran</option>
                                        <option value="Universitas Hasanuddin" {{ old('university') == 'Universitas Hasanuddin' ? 'selected' : '' }}>Universitas Hasanuddin</option>
                                        <option value="Universitas Sumatera Utara" {{ old('university') == 'Universitas Sumatera Utara' ? 'selected' : '' }}>Universitas Sumatera Utara</option>
                                        <option value="Universitas Sebelas Maret" {{ old('university') == 'Universitas Sebelas Maret' ? 'selected' : '' }}>Universitas Sebelas Maret</option>
                                        <option value="Universitas Negeri Yogyakarta" {{ old('university') == 'Universitas Negeri Yogyakarta' ? 'selected' : '' }}>Universitas Negeri Yogyakarta</option>
                                        <option value="Universitas Pendidikan Indonesia" {{ old('university') == 'Universitas Pendidikan Indonesia' ? 'selected' : '' }}>Universitas Pendidikan Indonesia</option>
                                        <!-- SMA/SMK Populer -->
                                        <option value="SMA Negeri" {{ old('university') == 'SMA Negeri' ? 'selected' : '' }}>SMA Negeri</option>
                                        <option value="SMA Swasta" {{ old('university') == 'SMA Swasta' ? 'selected' : '' }}>SMA Swasta</option>
                                        <option value="SMK Negeri" {{ old('university') == 'SMK Negeri' ? 'selected' : '' }}>SMK Negeri</option>
                                        <option value="SMK Swasta" {{ old('university') == 'SMK Swasta' ? 'selected' : '' }}>SMK Swasta</option>
                                        <option value="MA (Madrasah Aliyah)" {{ old('university') == 'MA (Madrasah Aliyah)' ? 'selected' : '' }}>MA (Madrasah Aliyah)</option>
                                        <option value="Lainnya" {{ old('university') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                    @error('university')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
