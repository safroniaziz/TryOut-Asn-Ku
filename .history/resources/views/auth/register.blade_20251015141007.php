                ...
                <div class="w-full max-w-2xl">
                    ...
                    <div class="bg-white rounded-2xl px-6 py-8 shadow-2xl register-form">
                        ...
                        <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
                            ...
                            <button type="button" 
                                    id="prevBtn"
                                    class="flex items-center space-x-2 px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg transition-all duration-300 text-sm font-medium"
                                    style="display: none;">
                            ...
                            <button type="button" 
                                    id="nextBtn"
                                    class="flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-2.5 px-6 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] text-sm ml-auto">
                                <span id="nextBtnText">Lanjutkan</span>
                                <i class="fas fa-arrow-right text-xs" id="nextBtnIcon"></i>
                            </button>
                        </div>
                        </form>
