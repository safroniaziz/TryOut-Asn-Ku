@extends('layouts.app')<!DOCTYPE html><!DOCTYPE html><!DOCTYPE html><!DOCTYPE html><!DOCTYPE html><!DOCTYPE html><!DOCTYPE html>



@section('content')<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

<div class="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex">

    <!-- Left Side - Branding --><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

    <div class="hidden lg:flex lg:w-1/2 flex-col justify-center px-12">

        <div class="text-white">    <meta charset="utf-8">

            <h1 class="text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">

                TryOut ASNku    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

            </h1>

            <p class="text-xl text-gray-300 mb-8 leading-relaxed">    <meta name="csrf-token" content="{{ csrf_token() }}">

                Platform persiapan tes CPNS terdepan dengan soal-soal berkualitas tinggi dan analisis mendalam.

            </p>    <title>Masuk - TryOut ASNku</title>    <meta charset="utf-8">

            <div class="space-y-4">

                <div class="flex items-center space-x-3">    @vite(['resources/css/app.css', 'resources/js/app.js'])

                    <div class="w-2 h-2 bg-cyan-400 rounded-full"></div>

                    <span class="text-gray-300">Ribuan soal berkualitas tinggi</span></head>    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

                </div>

                <div class="flex items-center space-x-3"><body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700">

                    <div class="w-2 h-2 bg-blue-400 rounded-full"></div>

                    <span class="text-gray-300">Analisis mendalam hasil tryout</span>    <div class="min-h-screen flex">    <meta name="csrf-token" content="{{ csrf_token() }}">

                </div>

                <div class="flex items-center space-x-3">        <!-- Left Side -->

                    <div class="w-2 h-2 bg-purple-400 rounded-full"></div>

                    <span class="text-gray-300">Ranking nasional real-time</span>        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-purple-700 items-center justify-center p-12">    <title>Masuk - TryOut ASNku</title>    <meta charset="utf-8">

                </div>

            </div>            <div class="max-w-md text-white text-center">

        </div>

    </div>                <div class="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-4">    



    <!-- Right Side - Login Form -->                    <i class="fas fa-graduation-cap text-blue-600 text-2xl"></i>

    <div class="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">

        <div class="w-full max-w-md">                </div>    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

            <!-- Mobile Logo -->

            <div class="lg:hidden text-center mb-8">                <h1 class="text-3xl font-bold mb-2">TryOut ASNku</h1>

                <h1 class="text-3xl font-bold text-white mb-2">TryOut ASNku</h1>

                <p class="text-gray-300">Masuk ke akun Anda</p>                <p class="text-blue-100 mb-8">Platform Persiapan ASN Terdepan</p>    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8 shadow-2xl">                <h2 class="text-xl font-semibold mb-3">Selamat Datang Kembali!</h2>    @vite(['resources/css/app.css', 'resources/js/app.js'])    <meta name="csrf-token" content="{{ csrf_token() }}">

                <div class="text-center mb-8">

                    <h2 class="text-2xl font-bold text-white mb-2">Selamat Datang Kembali</h2>                <p class="text-blue-100 mb-6">Lanjutkan persiapan ASN terbaikmu</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">                <div class="space-y-3 text-left">

                    @csrf

                    <div class="flex items-center space-x-3"><body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 font-inter">    <title>Masuk - TryOut ASNku</title>    <meta charset="utf-8">

                    <!-- Email -->

                    <div>                        <div class="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center">

                        <label for="email" class="block text-sm font-medium text-gray-200 mb-2">

                            Email                            <i class="fas fa-check text-white text-sm"></i>    <div class="min-h-screen flex">
                        ...
                        <input id="email"                         </div>
                               ...
                               name="email"                         <span>50,000+ Soal Premium</span>        <!-- Left Side - Branding -->    
                               ...
                               class="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all duration-200">                    <div class="flex items-center space-x-3">        <div class="hidden lg:flex lg:w-1/2 relative">

                        @error('email')

                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>                        <div class="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">

                        @enderror

                    </div>                            <i class="fas fa-chart-line text-white text-sm"></i>            <div class="w-full bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-12">    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}"><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                    ...
                    <div>
                        ...
                        <label for="password" class="block text-sm font-medium text-gray-200 mb-2">                        <span>Analisis Mendalam</span>                <div class="max-w-md text-white">
                        ...
                        <input id="password" 
                               ...
                               type="password"                     <div class="flex items-center space-x-3">                    <div class="text-center mb-8">    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">

                               name="password" 

                               required                         <div class="w-8 h-8 bg-purple-500 rounded-lg flex items-center justify-center">

                               autocomplete="current-password"

                               class="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all duration-200">                            <i class="fas fa-users text-white text-sm"></i>                        <div class="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-4">

                        @error('password')

                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>                        </div>

                        @enderror

                    </div>                        <span>Komunitas Elite</span>                            <i class="fas fa-graduation-cap text-blue-600 text-2xl"></i>    @vite(['resources/css/app.css', 'resources/js/app.js'])    <meta name="csrf-token" content="{{ csrf_token() }}">



                    <!-- Remember Me & Forgot Password -->                    </div>

                    <div class="flex items-center justify-between">

                        <label class="flex items-center">                </div>                        </div>
                            ...
                            <span class="ml-2 text-sm text-gray-300">Ingat saya</span>        </div>                        <h1 class="text-3xl font-bold mb-2">TryOut ASNku</h1></head>
                        ...
                        @if (Route::has('password.request'))
                            ...
                            <a href="{{ route('password.request') }}"         <!-- Right Side -->                        <p class="text-blue-100">Platform Persiapan ASN Terdepan</p>

                               class="text-sm text-cyan-400 hover:text-cyan-300 transition-colors duration-200">

                                Lupa password?        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">

                            </a>

                        @endif            <div class="w-full max-w-md">                    </div><body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 font-['Inter']">    <meta charset="utf-8">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <button type="submit"                     <h3 class="text-2xl font-bold text-gray-900 mb-2 text-center">Masuk Akun</h3>                    
                        ...
                        Masuk                    <p class="text-gray-600 text-center mb-8">Silakan masuk untuk melanjutkan</p>

                    </button>

                </form>                                        <div class="text-center mb-8">    <div class="min-h-screen flex">



                <!-- Register Link -->                    <x-auth-session-status class="mb-4" :status="session('status')" />

                <div class="mt-6 text-center">

                    <p class="text-gray-300">                                            <h2 class="text-xl font-semibold mb-3">Selamat Datang Kembali!</h2>

                        Belum punya akun? 

                        <a href="{{ route('register') }}"                     <form method="POST" action="{{ route('login') }}" class="space-y-6">

                           class="text-cyan-400 hover:text-cyan-300 font-medium transition-colors duration-200">

                            Daftar sekarang                        @csrf                        <p class="text-blue-100">Lanjutkan persiapan ASN terbaikmu</p>        <!-- Left Side - Branding -->    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>
...
@endsection                            <input                             <div class="hidden lg:flex lg:w-1/2 relative">

                                id="email" 

                                type="email"                     <div class="space-y-4">

                                name="email" 

                                value="{{ old('email') }}"                         <div class="flex items-center space-x-3">            <div class="w-full bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-12">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><head>

                                required 

                                autofocus                             <div class="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center">

                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"

                                placeholder="Masukkan email Anda"                                <i class="fas fa-check text-white text-sm"></i>                <div class="max-w-md text-white">
                            ...
                            <x-input-error :messages="$errors->get('email')" class="mt-2" />                            </div>
                                                    ...
                                                    <span>50,000+ Soal Premium</span>                    <div class="text-center mb-8">    <!-- Fonts -->

                        <div>

                            <label for="password" class="block text-sm font-medium text-gray-700 mb-2">Password</label>                        </div>

                            <input 

                                id="password"                         <div class="flex items-center space-x-3">                        <div class="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-4">

                                type="password" 

                                name="password"                             <div class="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">

                                required 

                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"                                <i class="fas fa-chart-line text-white text-sm"></i>                            <i class="fas fa-graduation-cap text-blue-600 text-2xl"></i>    <link rel="preconnect" href="https://fonts.googleapis.com">    <meta name="csrf-token" content="{{ csrf_token() }}">
                        ...
                        </div>                            <span>Analisis Mendalam</span>                        </div>
                        ...
                        <div class="flex items-center justify-between">                        </div>
                            ...
                            <label class="flex items-center">
                                ...
                                <input type="checkbox" name="remember" class="w-4 h-4 text-blue-600 border-gray-300 rounded">                        <div class="flex items-center space-x-3">                        <h1 class="text-3xl font-bold mb-2">TryOut ASNku</h1>    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>

                                <span class="ml-2 text-sm text-gray-600">Ingat saya</span>

                            </label>                            <div class="w-8 h-8 bg-purple-500 rounded-lg flex items-center justify-center">

                            @if (Route::has('password.request'))

                                <a href="{{ route('password.request') }}" class="text-sm text-blue-600 hover:text-blue-500">                                <i class="fas fa-users text-white text-sm"></i>                        <p class="text-blue-100">Platform Persiapan ASN Terdepan</p>
                        ...
                        </div>                            <span>Komunitas Elite</span>                    </div>    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">    <meta charset="utf-8">    <meta charset="utf-8">
                        ...
                        <button                         </div>
                            ...
                            class="w-full bg-gradient-to-r from-blue-600 to-purple-700 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-800"                    </div>                    
                        ...
                        <div class="text-center pt-4 border-t border-gray-200">
                            ...
                            <p class="text-gray-600">        </div>
                                ...
                                <a href="{{ route('register') }}" class="text-blue-600 font-semibold hover:text-blue-500">                                <h2 class="text-xl font-semibold mb-3">Selamat Datang Kembali!</h2>

                                    Daftar gratis

                                </a>        <!-- Right Side - Login Form -->

                            </p>

                        </div>        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">                        <p class="text-blue-100">Lanjutkan persiapan ASN terbaikmu</p>    <!-- Icons -->    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>
        ...
        </div>                <div class="bg-white rounded-2xl shadow-xl p-8">                    </div>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
...
</body>                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Masuk Akun</h3>                        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
                    ...
                    <x-auth-session-status class="mb-4" :status="session('status')" />                        <div class="flex items-center space-x-3">    <meta name="viewport" content="width=device-width, initial-scale=1">    <meta name="viewport" content="width=device-width, initial-scale=1">

                    

                    <form method="POST" action="{{ route('login') }}" class="space-y-6">                            <div class="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center">

                        @csrf

                                                        <i class="fas fa-check text-white text-sm"></i>    <!-- Scripts -->

                        <div>

                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email</label>                            </div>

                            <input 

                                id="email"                             <span>50,000+ Soal Premium</span>    @vite(['resources/css/app.css', 'resources/js/app.js'])    <!-- Fonts -->
                                ...
                                required                         <div class="flex items-center space-x-3">

                                autofocus 

                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"                            <div class="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">

                                placeholder="Masukkan email Anda"

                            >                                <i class="fas fa-chart-line text-white text-sm"></i>    <style>    <link rel="preconnect" href="https://fonts.googleapis.com">    <meta name="csrf-token" content="{{ csrf_token() }}">    <meta name="csrf-token" content="{{ csrf_token() }}">
                        ...
                        <div>                            <span>Analisis Mendalam</span>        body {
                            ...
                            <input                         </div>
                                ...
                                type="password"                         <div class="flex items-center space-x-3">            font-family: 'Inter', sans-serif;    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
                                ...
                                placeholder="Masukkan password Anda"                                <i class="fas fa-users text-white text-sm"></i>        }
                            ...
                            <x-input-error :messages="$errors->get('password')" class="mt-2" />                            </div>
                                                    ...
                                                    <span>Komunitas Elite</span>    <link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <label class="flex items-center">                        </div>
                                ...
                                <span class="ml-2 text-sm text-gray-600">Ingat saya</span>                    </div>        .auth-container {
                            ...
                            @if (Route::has('password.request'))                </div>
                                ...
                                <a href="{{ route('password.request') }}" class="text-sm text-blue-600 hover:text-blue-500 transition-colors">
                                    ...
                                    Lupa password?            </div>            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
                        ...
                        <button 
                            ...
                            type="submit"         <!-- Right Side - Login Form -->
                        ...
                        >        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">        }    <!-- Icons -->    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>

                            Masuk Sekarang

                        </button>            <div class="w-full max-w-md">

                        

                        <div class="text-center pt-4 border-t border-gray-200">                <div class="bg-white rounded-2xl shadow-xl p-8">

                            <p class="text-gray-600">

                                Belum punya akun?                     <div class="text-center mb-8">

                                <a href="{{ route('register') }}" class="text-blue-600 font-semibold hover:text-blue-500 transition-colors">

                                    Daftar gratis                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Masuk Akun</h3>        .glass-effect {    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />

                                </a>

                            </p>                        <p class="text-gray-600">Silakan masuk untuk melanjutkan</p>

                        </div>

                    </form>                    </div>            background: rgba(255, 255, 255, 0.95);
    ...
    </div>                    <x-auth-session-status class="mb-4" :status="session('status')" />            backdrop-filter: blur(20px);

</body>

</html>                    

                    <form method="POST" action="{{ route('login') }}" class="space-y-6">            border: 1px solid rgba(255, 255, 255, 0.2);
                        ...
                        <div>
                            ...
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email</label>            box-shadow: 0 20px 40px rgba(0, 0, 0, 0.1);

                            <input 

                                id="email"         }    @vite(['resources/css/app.css', 'resources/js/app.js'])    <!-- Fonts -->    <!-- Fonts -->
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"            background: rgba(255, 255, 255, 0.1);
                        ...
                        <div>            border-radius: 20px;        body {
                            ...
                            <input         }
                                ...
                                type="password"             font-family: 'Inter', sans-serif;    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
                                ...
                                placeholder="Masukkan password Anda"            border: 2px solid #e5e7eb;        }

                            >

                            <x-input-error :messages="$errors->get('password')" class="mt-2" />            border-radius: 12px;
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <label class="flex items-center">        }
                                ...
                                <span class="ml-2 text-sm text-gray-600">Ingat saya</span>        .auth-bg {

                            </label>

                            @if (Route::has('password.request'))        .input-field:focus {

                                <a href="{{ route('password.request') }}" class="text-sm text-blue-600 hover:text-blue-500">

                                    Lupa password?            outline: none;            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);

                                </a>

                            @endif            border-color: #667eea;
                        ...
                        <div class="text-center pt-4 border-t border-gray-200">            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);        }

                            <p class="text-gray-600">

                                Belum punya akun?             border: none;

                                <a href="{{ route('register') }}" class="text-blue-600 font-semibold hover:text-blue-500">

                                    Daftar gratis            border-radius: 12px;            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
