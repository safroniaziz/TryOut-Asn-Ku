                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="major"
                                            ...
                                            <optgroup label="Teknik">
                                                ...
                                                <option value="Teknik Arsitektur" {{ old('major') == 'Teknik Arsitektur' ? 'selected' : '' }}>Arsitektur</option>
                                            ...
                                            <optgroup label="Kesehatan">
                                                ...
                                                <option value="Gizi" {{ old('major') == 'Gizi' ? 'selected' : '' }}>Gizi</option>
                                                ...
                                                <option value="Analis Kesehatan" {{ old('major') == 'Analis Kesehatan' ? 'selected' : '' }}>Analis Kesehatan</option>
                                                <option value="Radiologi" {{ old('major') == 'Radiologi' ? 'selected' : '' }}>Radiologi</option>
                                            </optgroup>
                                            ...
                                            <optgroup label="Seni & Desain">
                                                ...
                                                <option value="Desain Grafis" {{ old('major') == 'Desain Grafis' ? 'selected' : '' }}>Desain Komunikasi Visual</option>
                                                ...
                                                <option value="Film" {{ old('major') == 'Film' ? 'selected' : '' }}>Film & Televisi</option>
