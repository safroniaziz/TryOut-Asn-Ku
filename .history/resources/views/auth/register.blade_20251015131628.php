                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="space-y-1">
                                    <label for="used_referral_code" class="block text-xs font-medium text-gray-700">
                                        Kode Referral
                                        <button type="button"
                                                onclick="toggleReferralInfo()"
                                                class="ml-1 w-4 h-4 bg-blue-500 text-white rounded-full text-xs flex items-center justify-center hover:bg-blue-600 transition-colors duration-200">
                                            <i class="fas fa-info text-xs"></i>
                                        </button>
                                    </label>
                                    <div id="referral-info" class="hidden mb-2 p-2 bg-blue-50 border border-blue-200 rounded-lg">
                                        <p class="text-xs text-blue-700">
                                            <i class="fas fa-gift mr-1"></i>
                                            Masukkan kode referral dari teman untuk mendapat bonus poin dan akses fitur eksklusif!
                                        </p>
                                    </div>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none">
...
<script>
    function toggleReferralInfo() {
        const infoElement = document.getElementById('referral-info');
