...
<div class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    <div class="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-center justify-center min-h-screen">
            ...
            <div class="w-full lg:w-2/3 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 lg:p-12">
                <div class="register-form">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-6" id="wizardForm">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="space-y-1">
                                        ...
                                        <input id="name" type="text" name="name" value="{{ old('name') }}" required
                                               class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300 text-sm"
                                ...
                                <div class="space-y-1">
                                    ...
                                    <textarea id="address" name="address" required rows="3"
                                              class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300 text-sm resize-none"
                        ...
                        <div class="wizard-step" id="step3" style="display: none;">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="space-y-1">
                                    <label for="university" class="block text-xs font-medium text-gray-700">
                                ...
                                <div class="space-y-1">
                                    <label for="referral_code" class="block text-xs font-medium text-gray-700">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button" id="prevBtn"
                                    class="flex items-center space-x-2 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-800 rounded-lg transition-all duration-300 font-medium"
                            ...
                            <button type="button" id="nextBtn"
                                    class="flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-200 text-center">
                        <p class="text-sm text-gray-600">
                            Sudah punya akun?
                            <a href="{{ route('login') }}" class="font-bold text-blue-600 hover:text-blue-700 transition-colors duration-200">
                                Masuk di sini
                            </a>
                        </p>
                    </div>
