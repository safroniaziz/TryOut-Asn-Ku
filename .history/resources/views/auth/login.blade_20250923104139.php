...
<body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 font-['Inter']">    <meta charset="utf-8">

    <div class="min-h-screen flex">

        <!-- Left Side - Branding -->    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>

        <div class="hidden lg:flex lg:w-1/2 relative">

            <div class="w-full bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-12">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><head>
                ...
                <div class="max-w-md text-white">
                    ...
                    <div class="text-center mb-8">    <!-- Fonts -->
                        ...
                        <div class="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-4">
                            ...
                            <i class="fas fa-graduation-cap text-blue-600 text-2xl"></i>    <link rel="preconnect" href="https://fonts.googleapis.com">    <meta name="csrf-token" content="{{ csrf_token() }}">
                    ...
                    </div>    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">    <meta charset="utf-8">    <meta charset="utf-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-blue-100">Lanjutkan persiapan ASN terbaikmu</p>    <!-- Icons -->    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-3">    <meta name="viewport" content="width=device-width, initial-scale=1">    <meta name="viewport" content="width=device-width, initial-scale=1">
                            ...
                            <span>50,000+ Soal Premium</span>    @vite(['resources/css/app.css', 'resources/js/app.js'])    <!-- Fonts -->
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span>Analisis Mendalam</span>        body {

                        </div>

                        <div class="flex items-center space-x-3">            font-family: 'Inter', sans-serif;    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Masuk Akun</h3>        .glass-effect {    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
                    ...
                    <x-auth-session-status class="mb-4" :status="session('status')" />            backdrop-filter: blur(20px);
