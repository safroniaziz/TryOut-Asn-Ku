            ...
            <div class="hidden lg:flex lg:w-1/2 flex-col justify-center pr-8">
                <div class="text-white space-y-6">
                    ...
                    <div class="text-center lg:text-left">
                        <!-- Logo Icon -->
                        <div class="relative transform hover:scale-110 transition-all duration-500 mx-auto lg:mx-0 mb-6 w-20 h-20">
                        ...
                        <!-- Brand Name -->
                        <h1 class="text-5xl font-black mb-2 text-white">
                            TryOut<span class="text-orange-400">ASN</span>ku
                        </h1>
                        <div class="text-lg font-semibold text-blue-200 mb-4">
                            Platform Premium
                        </div>
