...
<div class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    <div class="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-center justify-center min-h-screen">
            ...
            <div class="w-full lg:w-2/3 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 lg:p-12 relative overflow-visible">
                <div class="register-form">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="space-y-1">
                                    <div class="flex items-center space-x-1">
                                        <label for="used_referral_code1" class="block text-xs font-medium text-gray-700">
                                            Kode Referral
                                        </label>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 bg-white/95 backdrop-blur-sm z-50 relative">
                        <!-- Step Progress Info -->
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button"
                                    ...
                                    style="display: flex !important; visibility: visible !important; opacity: 1 !important; position: relative !important;">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        setTimeout(() => {
            ...
            if (nextBtn) {
                // Forcefully clear any hiding inline styles and ensure visibility
            ...
            if (prevBtn) {
                ...
                prevBtn.style.removeProperty('visibility');
            ...
            // Ensure navigation container sits above other content
            const navContainer = document.querySelector('.mt-8.pt-6.border-t');
            if (navContainer) {
                navContainer.style.zIndex = '1200';
    ...
    function initWizard() {
        ...
        if (!nextBtn || !prevBtn) {
            console.error('❌ Buttons not found!', { nextBtn, prevBtn });
            return;
        }

        // FORCE SHOW buttons immediately
        nextBtn.style.display = 'flex';
        nextBtn.style.visibility = 'visible';
        nextBtn.style.opacity = '1';
        ...
        console.log('✅ Buttons forced visible');
...
<style>
    ...
    /* 🎯 Simplified Form Field Interactions */
    ...
    /* Force ALL elements visible - EMERGENCY DEBUG */
    ...
    button[id="nextBtn"], button[id="prevBtn"] {
        display: flex !important;
        visibility: visible !important;
        opacity: 1 !important;
