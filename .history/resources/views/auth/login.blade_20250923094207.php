...
<head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}"><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Sora:wght@100;200;300;400;500;600;700;800&display=swap" rel="stylesheet">
        ...
        .auth-bg::before {
            ...
            right: 0;    @vite(['resources/css/app.css', 'resources/js/app.js'])    @vite(['resources/css/app.css', 'resources/js/app.js'])
            ...
            background-image: 
                ...
                radial-gradient(circle at 75% 75%, rgba(255, 255, 255, 0.1) 0%, transparent 50%);    <style>    <style>
        ...
        @keyframes subtle-float {            font-family: 'Inter', sans-serif;            margin: 0;
        ...
        .glass-card {
            ...
            background: rgba(255, 255, 255, 0.95);        .auth-bg {        }

            backdrop-filter: blur(25px);

            border: 1px solid rgba(255, 255, 255, 0.3);            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);

            box-shadow: 

                0 25px 50px -12px rgba(0, 0, 0, 0.25),            position: relative;        body {
        ...
        .brand-card {                    min-height: 100vh;

            background: linear-gradient(135deg, rgba(255, 255, 255, 0.15) 0%, rgba(255, 255, 255, 0.05) 100%);

            backdrop-filter: blur(25px);        .auth-bg::before {            position: relative;
            ...
            box-shadow:             content: '';        }
                ...
                inset 0 1px 0 rgba(255, 255, 255, 0.1);            position: absolute;
        ...
        .premium-input {            left: 0;        body::before {

            background: rgba(255, 255, 255, 0.95);

            border: 2px solid rgba(102, 126, 234, 0.15);            right: 0;            content: '';
        ...
        .premium-input:focus {                radial-gradient(circle at 25% 25%, rgba(255, 255, 255, 0.1) 0%, transparent 50%),            left: 0;

            outline: none;

            border-color: #667eea;                radial-gradient(circle at 75% 75%, rgba(255, 255, 255, 0.1) 0%, transparent 50%);            right: 0;
            ...
            box-shadow:             animation: subtle-float 8s ease-in-out infinite alternate;            bottom: 0;
                ...
                0 10px 25px rgba(102, 126, 234, 0.15);        }            background-image: 
        ...
        .premium-btn {        @keyframes subtle-float {                radial-gradient(circle at 75% 75%, rgba(255, 255, 255, 0.1) 0%, transparent 50%);

            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);

            border: none;            0%, 100% { transform: translateY(0px); }            animation: float 6s ease-in-out infinite;

            border-radius: 16px;

            color: white;            50% { transform: translateY(-10px); }        }
            ...
            position: relative;        @keyframes float {
        ...
        .premium-btn::before {            background: rgba(255, 255, 255, 0.95);            50% { transform: translateY(-20px); }

            content: '';

            position: absolute;            backdrop-filter: blur(25px);        }

            top: 0;

            left: -100%;            border: 1px solid rgba(255, 255, 255, 0.3);

            width: 100%;

            height: 100%;            box-shadow:         /* Premium Glass Card */

            background: linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.2), transparent);

            transition: left 0.6s;                0 25px 50px -12px rgba(0, 0, 0, 0.25),        .glass-card {
