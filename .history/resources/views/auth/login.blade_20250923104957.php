...
<head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>Masuk - TryOut ASNku</title>    <meta charset="utf-8">

    @vite(['resources/css/app.css', 'resources/js/app.js'])

</head>    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

<body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700">

    <div class="min-h-screen flex">    <meta name="csrf-token" content="{{ csrf_token() }}">

        <!-- Left Side -->

        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-purple-700 items-center justify-center p-12">    <title>Masuk - TryOut ASNku</title>    <meta charset="utf-8">
            ...
            <div class="max-w-md text-white text-center">
                ...
                </div>    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

                <h1 class="text-3xl font-bold mb-2">TryOut ASNku</h1>

                <p class="text-blue-100 mb-8">Platform Persiapan ASN Terdepan</p>    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">

                

                <h2 class="text-xl font-semibold mb-3">Selamat Datang Kembali!</h2>    @vite(['resources/css/app.css', 'resources/js/app.js'])    <meta name="csrf-token" content="{{ csrf_token() }}">

                <p class="text-blue-100 mb-6">Lanjutkan persiapan ASN terbaikmu</p>
                ...
                <div class="space-y-3 text-left">
                    ...
                    <div class="flex items-center space-x-3"><body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 font-inter">    <title>Masuk - TryOut ASNku</title>    <meta charset="utf-8">
                        ...
                        <div class="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center">
                            ...
                            <i class="fas fa-check text-white text-sm"></i>    <div class="min-h-screen flex">

                        </div>

                        <span>50,000+ Soal Premium</span>        <!-- Left Side - Branding -->    

                    </div>

                    <div class="flex items-center space-x-3">        <div class="hidden lg:flex lg:w-1/2 relative">

                        <div class="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">

                            <i class="fas fa-chart-line text-white text-sm"></i>            <div class="w-full bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-12">    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">    <meta name="viewport" content="width=device-width, initial-scale=1"><head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}"><html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

                        </div>

                        <span>Analisis Mendalam</span>                <div class="max-w-md text-white">

                    </div>

                    <div class="flex items-center space-x-3">                    <div class="text-center mb-8">    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">

                        <div class="w-8 h-8 bg-purple-500 rounded-lg flex items-center justify-center">

                            <i class="fas fa-users text-white text-sm"></i>                        <div class="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-4">

                        </div>

                        <span>Komunitas Elite</span>                            <i class="fas fa-graduation-cap text-blue-600 text-2xl"></i>    @vite(['resources/css/app.css', 'resources/js/app.js'])    <meta name="csrf-token" content="{{ csrf_token() }}">
        ...
        </div>                        <h1 class="text-3xl font-bold mb-2">TryOut ASNku</h1></head>

        

        <!-- Right Side -->                        <p class="text-blue-100">Platform Persiapan ASN Terdepan</p>

        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">

            <div class="w-full max-w-md">                    </div><body class="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 font-['Inter']">    <meta charset="utf-8">

                <div class="bg-white rounded-2xl shadow-xl p-8">

                    <h3 class="text-2xl font-bold text-gray-900 mb-2 text-center">Masuk Akun</h3>                    
                    ...
                    <x-auth-session-status class="mb-4" :status="session('status')" />
                                            ...
                                            <h2 class="text-xl font-semibold mb-3">Selamat Datang Kembali!</h2>

                    <form method="POST" action="{{ route('login') }}" class="space-y-6">

                        @csrf                        <p class="text-blue-100">Lanjutkan persiapan ASN terbaikmu</p>        <!-- Left Side - Branding -->    <title>{{ config('app.name', 'Laravel') }} - Masuk</title>
                        ...
                        <div>                    </div>
                            ...
                            <input                             <div class="hidden lg:flex lg:w-1/2 relative">
