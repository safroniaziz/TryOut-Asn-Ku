                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex gap-2">
                                            <input id="email" type="email" name="email" value="{{ old('email') }}" required
                                                   class="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300"
                                                   placeholder="Email address">
                                            <button type="button" id="sendOtpBtn"
                                                    class="px-4 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 text-sm font-medium whitespace-nowrap"
                                                    disabled>
                                                Kirim OTP
                                            </button>
                                        </div>
                                        ...
                                        <div id="emailVerificationStatus" class="hidden">
                                            <div class="flex items-center text-sm">
                                                <svg class="w-4 h-4 mr-2 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                                </svg>
                                                <span class="text-green-600 font-medium">Email berhasil diverifikasi!</span>
                                            </div>
                                        </div>
                                    </div>

                                    <!-- OTP Verification Field (Hidden by default) -->
                                    <div id="otpVerificationSection" class="space-y-2 hidden">
                                        <label for="otp_code" class="block text-sm font-semibold text-gray-700">
                                            Kode OTP <span class="text-red-500">*</span>
                                        </label>
                                        <div class="flex gap-2">
                                            <input id="otp_code" type="text" maxlength="6"
                                                   class="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 text-center text-lg font-mono tracking-wider"
                                                   placeholder="000000">
                                            <button type="button" id="verifyOtpBtn"
                                                    class="px-4 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 focus:ring-2 focus:ring-green-500/20 transition-all duration-300 text-sm font-medium whitespace-nowrap">
                                                Verifikasi
                                            </button>
                                        </div>
                                        <p class="text-xs text-gray-600">
                                            Masukkan 6 digit kode OTP yang dikirim ke email Anda. Kode berlaku selama 3 menit.
                                        </p>

                                        <!-- OTP Timer dan Status -->
                                        <div class="text-center space-y-2">
                                            <!-- Countdown Timer OTP -->
                                            <div id="otpExpiryTimer" class="hidden">
                                                <div class="bg-orange-50 border border-orange-200 rounded-lg p-3">
                                                    <div class="flex items-center justify-center space-x-2">
                                                        ...
                                                        <span class="text-sm font-medium text-orange-700">
                                                            Kode OTP berlaku: <span id="otpTimeRemaining" class="font-mono font-bold">03:00</span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Expired Notice -->
                                            <div id="otpExpiredNotice" class="hidden">
                                        ...
                                        <div class="text-center">
                                            <button type="button" id="resendOtpBtn"
                                                    class="text-sm text-blue-600 hover:text-blue-700 underline hidden">
                                                Kirim ulang kode OTP
                                            </button>
                                            <div id="resendCountdown" class="text-sm text-gray-600"></div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    function setupEmailVerification() {
        ...
        // Enable send OTP button when email is valid
        emailInput.addEventListener('input', function() {
            ...
            if (isValidEmail) {
                ...
                // Hide verification sections if email is invalid
                if (!emailVerified) {
        ...
        sendOtpBtn.addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (data.expires_at) {
                        otpExpiryTime = data.expires_at * 1000; // Convert to milliseconds
        ...
        resendOtpBtn.addEventListener('click', function() {
            ...
            // Reset UI
            document.getElementById('otpExpiryTimer').classList.add('hidden');
            document.getElementById('otpExpiredNotice').classList.add('hidden');
