                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-6" id="wizardForm">
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-center">
                                    <button type="button" id="skipStep1" class="text-xs text-gray-400 hover:text-gray-600 transition-colors" style="display: none;">
                                        Lewati tahap ini →
                                    </button>
                                </div>
                                ...
                                <button type="button"
                                    ...
                                    <div class="relative z-10 flex items-center space-x-3">
                                        <span id="nextBtnText1" class="font-bold">Lanjutkan</span>
                                        <i class="fas fa-arrow-right text-lg group-hover:translate-x-1 transition-transform" id="nextBtnIcon1"></i>
                                    </div>
