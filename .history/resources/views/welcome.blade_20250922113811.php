...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth"><html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <head>    <head>
        ...
        <title>TryOut ASNku - Platform Terbaik Persiapan CPNS & PPPK Indonesia</title>        <title>TryOut ASNku - Platform Terbaik Persiapan CPNS & PPPK Indonesia</title>
        ...
        <style>        <style>
            ...
            .gradient-bg {            .gradient-bg {
                ...
                background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 25%, #3b82f6 50%, #f97316 75%, #ea580c 100%);                background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 25%, #3b82f6 50%, #f97316 75%, #ea580c 100%);
            ...
            .text-gradient {            .text-gradient {
                ...
                background: linear-gradient(45deg, #3b82f6, #f97316);                background: linear-gradient(45deg, #3b82f6, #f97316);
    ...
    <body class="font-inter antialiased overflow-x-hidden">    <body class="font-inter antialiased overflow-x-hidden">

                

        <!-- Navigation -->        <!-- Navigation -->

        <nav class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-lg border-b border-blue-100">        <nav class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-lg border-b border-blue-100">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between h-16">                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-8">                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="#features" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Fitur</a>                        <a href="#features" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Fitur</a>

                        <a href="#pricing" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Harga</a>                        <a href="#pricing" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Harga</a>

                        <a href="#testimonials" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Testimoni</a>                        <a href="#testimonials" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Testimoni</a>
                    ...
                    <div class="flex items-center space-x-4">                    <div class="flex items-center space-x-4">
                        ...
                        @else                        @else
                            ...
                            <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">                            <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">
        ...
        <section class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden pt-16">        <section class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none">            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div class="floating-animation absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full"></div>                <div class="floating-animation absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full"></div>

                <div class="floating-animation absolute top-40 right-20 w-32 h-32 bg-white/5 rounded-full" style="animation-delay: 1s;"></div>                <div class="floating-animation absolute top-40 right-20 w-32 h-32 bg-white/5 rounded-full" style="animation-delay: 1s;"></div>

                <div class="floating-animation absolute bottom-40 left-20 w-16 h-16 bg-white/10 rounded-full" style="animation-delay: 2s;"></div>                <div class="floating-animation absolute bottom-40 left-20 w-16 h-16 bg-white/10 rounded-full" style="animation-delay: 2s;"></div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <div class="max-w-4xl mx-auto">                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="inline-flex items-center glass-morphism px-6 py-3 rounded-full text-white mb-8">                    <div class="inline-flex items-center glass-morphism px-6 py-3 rounded-full text-white mb-8">

                        <i class="fas fa-star text-yellow-300 mr-2"></i>                        <i class="fas fa-star text-yellow-300 mr-2"></i>

                        <span class="font-medium">Platform #1 Persiapan CPNS & PPPK Indonesia</span>                        <span class="font-medium">Platform #1 Persiapan CPNS & PPPK Indonesia</span>
                    ...
                    <h1 class="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">                    <h1 class="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">

                        Raih Impian                         Raih Impian 
                        ...
                        <br>Bersama Kami                        <br>Bersama Kami
                    ...
                    <p class="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">                    <p class="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">

                        Platform tryout online terlengkap dengan ribuan soal CPNS & PPPK,                         Platform tryout online terlengkap dengan ribuan soal CPNS & PPPK, 

                        pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu                        pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                        ...
                        @auth                        @auth
                            ...
                            <a href="{{ url('/dashboard') }}" class="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">                            <a href="{{ url('/dashboard') }}" class="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">
                                ...
                                <i class="fas fa-tachometer-alt mr-2"></i>                                <i class="fas fa-tachometer-alt mr-2"></i>
                        ...
                        @else                        @else
                            ...
                            <a href="{{ route('register') }}" class="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">                            <a href="{{ route('register') }}" class="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">
                                ...
                                Mulai Gratis Sekarang                                Mulai Gratis Sekarang

                            </a>                            </a>

                        @endauth                        @endauth

                        <a href="#features" class="glass-morphism text-white hover:bg-white/20 px-8 py-4 rounded-xl font-bold text-lg transition-all">                        <a href="#features" class="glass-morphism text-white hover:bg-white/20 px-8 py-4 rounded-xl font-bold text-lg transition-all">

                            <i class="fas fa-play mr-2"></i>                            <i class="fas fa-play mr-2"></i>

                            Lihat Demo                            Lihat Demo
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">

                        <div class="text-center">                        <div class="text-center">

                            <div class="text-3xl font-black text-white mb-2">10K+</div>                            <div class="text-3xl font-black text-white mb-2">10K+</div>

                            <div class="text-blue-200 text-sm">Soal Tersedia</div>                            <div class="text-blue-200 text-sm">Soal Tersedia</div>

                        </div>                        </div>

                        <div class="text-center">                        <div class="text-center">

                            <div class="text-3xl font-black text-white mb-2">5K+</div>                            <div class="text-3xl font-black text-white mb-2">5K+</div>

                            <div class="text-blue-200 text-sm">Peserta Aktif</div>                            <div class="text-blue-200 text-sm">Peserta Aktif</div>

                        </div>                        </div>

                        <div class="text-center">                        <div class="text-center">

                            <div class="text-3xl font-black text-white mb-2">98%</div>                            <div class="text-3xl font-black text-white mb-2">98%</div>

                            <div class="text-blue-200 text-sm">Tingkat Kepuasan</div>                            <div class="text-blue-200 text-sm">Tingkat Kepuasan</div>

                        </div>                        </div>

                        <div class="text-center">                        <div class="text-center">

                            <div class="text-3xl font-black text-white mb-2">1K+</div>                            <div class="text-3xl font-black text-white mb-2">1K+</div>
            ...
            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">

                <i class="fas fa-chevron-down text-2xl"></i>                <i class="fas fa-chevron-down text-2xl"></i>
        ...
        <section id="features" class="py-20 bg-white">        <section id="features" class="py-20 bg-white">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16">                <div class="text-center mb-16">
                    ...
                    <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-6">                    <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-6">
                        ...
                        Semua yang Kamu Butuhkan untuk                         Semua yang Kamu Butuhkan untuk 

                        <span class="text-gradient">Sukses ASN</span>                        <span class="text-gradient">Sukses ASN</span>

                    </h2>                    </h2>

                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">

                        Platform komprehensif dengan fitur-fitur canggih yang dirancang khusus untuk membantu calon ASN meraih impiannya                        Platform komprehensif dengan fitur-fitur canggih yang dirancang khusus untuk membantu calon ASN meraih impiannya
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-2">                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">                        <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">

                            <i class="fas fa-brain text-white text-2xl"></i>                            <i class="fas fa-brain text-white text-2xl"></i>

                        </div>                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-4">10,000+ Soal Premium</h3>                        <h3 class="text-xl font-bold text-gray-900 mb-4">10,000+ Soal Premium</h3>

                        <p class="text-gray-600 leading-relaxed">                        <p class="text-gray-600 leading-relaxed">

                            Koleksi soal terlengkap dengan pembahasan detail untuk semua kategori CPNS & PPPK                            Koleksi soal terlengkap dengan pembahasan detail untuk semua kategori CPNS & PPPK
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-orange-200 transition-all duration-300 transform hover:-translate-y-2">                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-orange-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">                        <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">

                            <i class="fas fa-stopwatch text-white text-2xl"></i>                            <i class="fas fa-stopwatch text-white text-2xl"></i>

                        </div>                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-4">Simulasi Real-Time</h3>                        <h3 class="text-xl font-bold text-gray-900 mb-4">Simulasi Real-Time</h3>

                        <p class="text-gray-600 leading-relaxed">                        <p class="text-gray-600 leading-relaxed">

                            Pengalaman tryout yang persis seperti ujian asli dengan timer dan sistem penilaian akurat                            Pengalaman tryout yang persis seperti ujian asli dengan timer dan sistem penilaian akurat
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-green-200 transition-all duration-300 transform hover:-translate-y-2">                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-green-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">                        <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <i class="fas fa-chart-line text-white text-2xl"></i>                            <i class="fas fa-chart-line text-white text-2xl"></i>

                        </div>                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-4">Analisis Performa</h3>                        <h3 class="text-xl font-bold text-gray-900 mb-4">Analisis Performa</h3>

                        <p class="text-gray-600 leading-relaxed">                        <p class="text-gray-600 leading-relaxed">

                            Laporan detail kemampuanmu dengan rekomendasi materi yang perlu diperdalam                            Laporan detail kemampuanmu dengan rekomendasi materi yang perlu diperdalam
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-purple-200 transition-all duration-300 transform hover:-translate-y-2">                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-purple-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">                        <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">

                            <i class="fas fa-trophy text-white text-2xl"></i>                            <i class="fas fa-trophy text-white text-2xl"></i>

                        </div>                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-4">Sistem Ranking</h3>                        <h3 class="text-xl font-bold text-gray-900 mb-4">Sistem Ranking</h3>

                        <p class="text-gray-600 leading-relaxed">                        <p class="text-gray-600 leading-relaxed">

                            Kompetisi sehat dengan peserta lain untuk memotivasi belajar lebih giat                            Kompetisi sehat dengan peserta lain untuk memotivasi belajar lebih giat
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-red-200 transition-all duration-300 transform hover:-translate-y-2">                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-red-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">                        <div class="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">

                            <i class="fas fa-book-open text-white text-2xl"></i>                            <i class="fas fa-book-open text-white text-2xl"></i>
                        ...
                        <p class="text-gray-600 leading-relaxed">                        <p class="text-gray-600 leading-relaxed">
                            ...
                            Ringkasan materi terkini sesuai kisi-kisi resmi dari berbagai instansi                            Ringkasan materi terkini sesuai kisi-kisi resmi dari berbagai instansi
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-indigo-200 transition-all duration-300 transform hover:-translate-y-2">                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-indigo-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">                        <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">

                            <i class="fas fa-mobile-alt text-white text-2xl"></i>                            <i class="fas fa-mobile-alt text-white text-2xl"></i>

                        </div>                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-4">Akses Mobile</h3>                        <h3 class="text-xl font-bold text-gray-900 mb-4">Akses Mobile</h3>

                        <p class="text-gray-600 leading-relaxed">                        <p class="text-gray-600 leading-relaxed">

                            Belajar kapan saja, di mana saja dengan platform yang responsif di semua device                            Belajar kapan saja, di mana saja dengan platform yang responsif di semua device
        ...
        <section id="pricing" class="py-20 bg-gray-50">        <section id="pricing" class="py-20 bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16">                <div class="text-center mb-16">
                    ...
                    <div class="inline-flex items-center bg-orange-50 px-4 py-2 rounded-full text-orange-600 font-medium mb-6">                    <div class="inline-flex items-center bg-orange-50 px-4 py-2 rounded-full text-orange-600 font-medium mb-6">

                        <i class="fas fa-gem mr-2"></i>                        <i class="fas fa-gem mr-2"></i>
                    ...
                    <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-6">                    <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-6">
                        ...
                        Investasi Terbaik untuk                         Investasi Terbaik untuk 

                        <span class="text-gradient">Masa Depanmu</span>                        <span class="text-gradient">Masa Depanmu</span>

                    </h2>                    </h2>

                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">

                        Pilih paket yang sesuai dengan kebutuhanmu. Semua paket sudah termasuk akses penuh ke seluruh fitur platform                        Pilih paket yang sesuai dengan kebutuhanmu. Semua paket sudah termasuk akses penuh ke seluruh fitur platform
                ...
                <div class="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">                <div class="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div class="bg-white border border-gray-200 rounded-3xl p-8 relative">                    <div class="bg-white border border-gray-200 rounded-3xl p-8 relative">
                        ...
                        <div class="text-center mb-8">                        <div class="text-center mb-8">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 mb-4">Paket Basic</h3>                            <h3 class="text-2xl font-bold text-gray-900 mb-4">Paket Basic</h3>

                            <div class="text-4xl font-black text-gray-900 mb-2">GRATIS</div>                            <div class="text-4xl font-black text-gray-900 mb-2">GRATIS</div>

                            <p class="text-gray-600">Untuk memulai persiapan</p>                            <p class="text-gray-600">Untuk memulai persiapan</p>
                        ...
                        <ul class="space-y-4 mb-8">                        <ul class="space-y-4 mb-8">
                            ...
                            <li class="flex items-center">                            <li class="flex items-center">
                                ...
                                <span class="text-gray-700">100 Soal latihan gratis</span>                                <span class="text-gray-700">100 Soal latihan gratis</span>
                            ...
                            <li class="flex items-center">                            <li class="flex items-center">
                                ...
                                <span class="text-gray-700">5 Tryout gratis per bulan</span>                                <span class="text-gray-700">5 Tryout gratis per bulan</span>
                            ...
                            <li class="flex items-center">                            <li class="flex items-center">
                                ...
                                <span class="text-gray-700">Akses materi dasar</span>                                <span class="text-gray-700">Akses materi dasar</span>

                            </li>                            </li>

                            <li class="flex items-center text-gray-400">                            <li class="flex items-center text-gray-400">

                                <i class="fas fa-times mr-3"></i>                                <i class="fas fa-times mr-3"></i>

                                <span>Pembahasan detail</span>                                <span>Pembahasan detail</span>
                            ...
                            <li class="flex items-center text-gray-400">                            <li class="flex items-center text-gray-400">
                                ...
                                <span>Analisis performa</span>                                <span>Analisis performa</span>
                        ...
                        <a href="{{ route('register') }}" class="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-4 rounded-xl font-bold text-center block transition-colors">                        <a href="{{ route('register') }}" class="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-4 rounded-xl font-bold text-center block transition-colors">
                    ...
                    <div class="bg-gradient-to-br from-blue-600 to-blue-700 border border-blue-500 rounded-3xl p-8 relative transform scale-105 shadow-2xl">                    <div class="bg-gradient-to-br from-blue-600 to-blue-700 border border-blue-500 rounded-3xl p-8 relative transform scale-105 shadow-2xl">
                        ...
                        <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">                        <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">
                            ...
                            <div class="bg-orange-500 text-white px-6 py-2 rounded-full text-sm font-bold">                            <div class="bg-orange-500 text-white px-6 py-2 rounded-full text-sm font-bold">
                        ...
                        <div class="text-center mb-8">                        <div class="text-center mb-8">
                            ...
                            <h3 class="text-2xl font-bold text-white mb-4">Paket Premium</h3>                            <h3 class="text-2xl font-bold text-white mb-4">Paket Premium</h3>

                            <div class="text-4xl font-black text-white mb-2">Rp 99K</div>                            <div class="text-4xl font-black text-white mb-2">Rp 99K</div>

                            <p class="text-blue-200">Per bulan</p>                            <p class="text-blue-200">Per bulan</p>
                        ...
                        <ul class="space-y-4 mb-8">                        <ul class="space-y-4 mb-8">
                            ...
                            <li class="flex items-center">                            <li class="flex items-center">
                                ...
                                <span class="text-white">Tryout unlimited</span>                                <span class="text-white">Tryout unlimited</span>
