                ...
                <div class="relative overflow-hidden">
                    ...
                    <div class="relative text-center py-20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
                            <div class="group !bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:!border-blue-500 animate-fade-in-up delay-100">
                            ...
                            <div class="group !bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:!border-orange-500 animate-fade-in-up delay-200">
                                <div class="text-6xl mb-6 transform group-hover:scale-110 transition-transform duration-300">🎯</div>
                                <h3 class="font-bold text-2xl !text-gray-900 mb-3 group-hover:!text-orange-600 transition-colors">Tryout Realistis</h3>
                            ...
                            <div class="group !bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:!border-blue-500 animate-fade-in-up delay-300">
                                <div class="text-6xl mb-6 transform group-hover:scale-110 transition-transform duration-300">🏆</div>
                                <h3 class="font-bold text-2xl !text-gray-900 mb-3 group-hover:!text-blue-600 transition-colors">Ranking & Analisis</h3>
                        ...
                        {{-- CTA Section - Clean Blue-Orange Design --}}
                        <div class="relative max-w-4xl mx-auto mb-12 animate-fade-in-up delay-400">
                            <div class="!bg-gradient-to-r !from-blue-600 !to-orange-600 rounded-3xl p-12 !text-white shadow-2xl">
                                ...
                                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                                    <a href="{{ route('tryouts.index') }}" class="group !bg-white !text-blue-700 hover:!bg-gray-50 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl flex items-center justify-center">
                                        <i class="fas fa-play-circle mr-2 text-2xl"></i>
                                        <span>Mulai Tryout</span>
                                        <i class="fas fa-arrow-right ml-2 transform group-hover:translate-x-1 transition-transform"></i>
                                    </a>
                                    <a href="{{ route('materis.index') }}" class="group !bg-white/10 hover:!bg-white/20 !text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 border-2 !border-white/50 flex items-center justify-center backdrop-blur-sm">
                                ...
                                <div class="grid grid-cols-3 gap-6 pt-8 border-t !border-white/30">
                                    <div class="text-center">
                                        <div class="text-4xl font-black mb-2 !text-white">5000+</div>
                                        <div class="text-sm !text-white/80">Soal Tersedia</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-4xl font-black mb-2 !text-white">1000+</div>
                                        <div class="text-sm !text-white/80">Pengguna Aktif</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-4xl font-black mb-2 !text-white">95%</div>
                        ...
                        {{-- Tips Box - Clean & Clear --}}
                        <div class="max-w-3xl mx-auto !bg-yellow-50 !border-l-4 !border-yellow-500 rounded-xl p-6 shadow-lg animate-fade-in-up delay-500">
                            <div class="flex items-start gap-4">
                                <div class="flex-shrink-0 w-14 h-14 !bg-yellow-500 rounded-xl flex items-center justify-center shadow-md">
                                    <i class="fas fa-lightbulb !text-white text-2xl"></i>
                                </div>
                                <div class="flex-1">
                                    <h4 class="text-xl font-black !text-gray-900 mb-2">💡 Tips Pro</h4>
                                    <p class="!text-gray-700 leading-relaxed">
                                        Mulai dengan tryout kategori <strong class="!text-blue-600">TWK (Tes Wawasan Kebangsaan)</strong> untuk mengukur kemampuan dasarmu. Lalu lanjut ke TIU dan TKP untuk persiapan maksimal!
                                    </p>
                                </div>
                            </div>
                        </div>                        {{-- Tips Box with Visible Lightbulb Icon --}}
