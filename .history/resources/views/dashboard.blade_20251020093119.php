                        ...
                        <div class="relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 p-6 h-full flex flex-col border border-gray-100 min-h-[280px]">
                            ...
                            <div class="flex-grow flex flex-col justify-center">
                                @if($userTryouts->count() > 0)
                                    ...
                                    <div class="text-4xl font-black text-transparent bg-gradient-to-r from-teal-600 to-green-600 bg-clip-text mb-2 tabular-nums">{{ $latestTryout->benar }}/{{ $latestTryout->benar + $latestTryout->salah + $latestTryout->tidak_dijawab }}</div>
                                    ...
                                    @endif
                                @else
                                    <div class="text-4xl font-black text-transparent bg-gradient-to-r from-teal-600 to-green-600 bg-clip-text mb-2 tabular-nums">0%</div>
                                    <div class="text-sm font-bold text-gray-700 uppercase tracking-wide mb-3">Aktivitas Terakhir</div>
