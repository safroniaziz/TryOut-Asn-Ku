...
<head>
    ...
    <style>
        ...
        /* Navbar scroll effect dengan background yang lebih solid */
        .navbar-scrolled {
...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500 bg-white/98 backdrop-blur-xl border-b border-gray-200/50" id="navbar">
        <!-- Subtle Background -->
        <div class="absolute inset-0 bg-gradient-to-r from-blue-50/30 to-orange-50/30"></div>
