...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth"><html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
        ...
        <meta name="description" content="Platform tryout online terlengkap untuk persiapan CPNS & PPPK. Ribuan soal, pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu.">        <meta charset="utf-8">        <meta charset="utf-8">



        <!-- Fonts -->        <meta name="viewport" content="width=device-width, initial-scale=1">        <meta name="viewport" content="width=device-width, initial-scale=1">

        <link rel="preconnect" href="https://fonts.googleapis.com">

        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>        <title>TryOut ASNku - Platform Terbaik Persiapan CPNS & PPPK Indonesia</title>        <title>TryOut ASNku - Platform Terbaik Persiapan CPNS & PPPK Indonesia</title>

        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">

                <meta name="description" content="Platform tryout online terlengkap untuk persiapan CPNS & PPPK. Ribuan soal, pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu.">        <meta name="description" content="Platform tryout online terlengkap untuk persiapan CPNS & PPPK. Ribuan soal, pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu.">
        ...
        <style>
            ...
            .gradient-bg {        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
                ...
                background-size: 400% 400%;        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
            ...
            .floating-animation {        <!-- Scripts -->        <!-- Scripts -->
            ...
            .glass-morphism {
                ...
                background: rgba(255, 255, 255, 0.1);                background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 25%, #3b82f6 50%, #f97316 75%, #ea580c 100%);                background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 25%, #3b82f6 50%, #f97316 75%, #ea580c 100%);

                backdrop-filter: blur(20px);

                border: 1px solid rgba(255, 255, 255, 0.2);                background-size: 400% 400%;                background-size: 400% 400%;
    ...
    </head>                0% { background-position: 0% 50%; }                0% { background-position: 0% 50%; }
    ...
    <body class="font-inter antialiased overflow-x-hidden">
        ...
        <nav class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-lg border-b border-blue-100">                100% { background-position: 0% 50%; }                100% { background-position: 0% 50%; }
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between h-16">            }            }
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-orange-500 rounded-xl flex items-center justify-center">
                            ...
                            <i class="fas fa-graduation-cap text-white text-xl"></i>            .floating-animation {            .floating-animation {

                        </div>

                        <span class="font-bold text-2xl text-gradient">TryOut ASNku</span>                animation: floating 3s ease-in-out infinite;                animation: floating 3s ease-in-out infinite;
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="#pricing" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Harga</a>            @keyframes floating {            @keyframes floating {
                    ...
                    <div class="flex items-center space-x-4">            }            }
                        ...
                        @auth
                            ...
                            <a href="{{ url('/dashboard') }}" class="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 py-2 rounded-lg font-medium transition-all transform hover:scale-105">

                                Dashboard

                            </a>            .glass-morphism {            .glass-morphism {

                        @else

                            <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">                background: rgba(255, 255, 255, 0.1);                background: rgba(255, 255, 255, 0.1);

                                Masuk

                            </a>                backdrop-filter: blur(20px);                backdrop-filter: blur(20px);
                ...
                </div>            .text-gradient {            .text-gradient {

            </div>

        </nav>                background: linear-gradient(45deg, #3b82f6, #f97316);                background: linear-gradient(45deg, #3b82f6, #f97316);



        <!-- Hero Section -->                -webkit-background-clip: text;                -webkit-background-clip: text;

        <section class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden pt-16">

            <!-- Floating Elements -->                -webkit-text-fill-color: transparent;                -webkit-text-fill-color: transparent;

            <div class="absolute inset-0 overflow-hidden pointer-events-none">

                <div class="floating-animation absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full"></div>                background-clip: text;                background-clip: text;
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <div class="max-w-4xl mx-auto">    </head>    </head>

                    <!-- Badge -->

                    <div class="inline-flex items-center glass-morphism px-6 py-3 rounded-full text-white mb-8">    <body class="font-inter antialiased overflow-x-hidden">    <body class="font-inter antialiased overflow-x-hidden">

                        <i class="fas fa-star text-yellow-300 mr-2"></i>

                        <span class="font-medium">Platform #1 Persiapan CPNS & PPPK Indonesia</span>
                    ...
                    <h1 class="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">        <nav class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-lg border-b border-blue-100">        <nav class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-lg border-b border-blue-100">

                        Raih Impian

                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-300">            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <!-- Subtitle -->                    <div class="flex items-center space-x-3">                    <div class="flex items-center space-x-3">

                    <p class="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">

                        Platform tryout online terlengkap dengan ribuan soal CPNS & PPPK,                         <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-orange-500 rounded-xl flex items-center justify-center">                        <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-orange-500 rounded-xl flex items-center justify-center">

                        pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu

                    </p>                            <i class="fas fa-graduation-cap text-white text-xl"></i>                            <i class="fas fa-graduation-cap text-white text-xl"></i>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                        ...
                        @auth                        <span class="font-bold text-2xl text-gradient">TryOut ASNku</span>                        <span class="font-bold text-2xl text-gradient">TryOut ASNku</span>
                            ...
                            <a href="{{ url('/dashboard') }}" class="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">
                                ...
                                <i class="fas fa-tachometer-alt mr-2"></i>                    </div>                    </div>
                        ...
                        @else
                            ...
                            <a href="{{ route('register') }}" class="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">                    <!-- Desktop Menu -->                    <!-- Desktop Menu -->

                                <i class="fas fa-rocket mr-2"></i>

                                Mulai Gratis Sekarang                    <div class="hidden md:flex items-center space-x-8">                    <div class="hidden md:flex items-center space-x-8">

                            </a>

                        @endauth                        <a href="#features" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Fitur</a>                        <a href="#features" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Fitur</a>

                        <a href="#features" class="glass-morphism text-white hover:bg-white/20 px-8 py-4 rounded-xl font-bold text-lg transition-all">

                            <i class="fas fa-play mr-2"></i>                        <a href="#pricing" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Harga</a>                        <a href="#pricing" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Harga</a>

                            Lihat Demo

                        </a>                        <a href="#testimonials" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Testimoni</a>                        <a href="#testimonials" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Testimoni</a>

                    </div>

                                            <a href="#contact" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Kontak</a>                        <a href="#contact" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Kontak</a>

                    <!-- Stats -->

                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">                    </div>                    </div>

                        <div class="text-center">

                            <div class="text-3xl font-black text-white mb-2">10K+</div>

                            <div class="text-blue-200 text-sm">Soal Tersedia</div>

                        </div>                    <!-- Auth Buttons -->                    <!-- Auth Buttons -->

                        <div class="text-center">

                            <div class="text-3xl font-black text-white mb-2">5K+</div>                    <div class="flex items-center space-x-4">                    <div class="flex items-center space-x-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-3xl font-black text-white mb-2">1K+</div>                            </a>                            </a>
            ...
            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">                            </a>                            </a>

                <i class="fas fa-chevron-down text-2xl"></i>

            </div>                            @if (Route::has('register'))                            @if (Route::has('register'))
        ...
        <section id="features" class="py-20 bg-white">                                    Daftar Gratis                                    Daftar Gratis
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16">
                    ...
                    <div class="inline-flex items-center bg-blue-50 px-4 py-2 rounded-full text-blue-600 font-medium mb-6">                            @endif                            @endif
                        ...
                        Fitur Unggulan                        @endauth                        @endauth
                    ...
                    <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-6">                    </div>                    </div>
                        ...
                        <span class="text-gradient">Sukses ASN</span>                </div>                </div>

                    </h2>

                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">            </div>            </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">        <!-- Hero Section -->        <!-- Hero Section -->
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-2">        <section class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden pt-16">        <section class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <i class="fas fa-brain text-white text-2xl"></i>            <!-- Floating Elements -->            <!-- Floating Elements -->

                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-4">10,000+ Soal Premium</h3>            <div class="absolute inset-0 overflow-hidden pointer-events-none">            <div class="absolute inset-0 overflow-hidden pointer-events-none">

                        <p class="text-gray-600 leading-relaxed">

                            Koleksi soal terlengkap dengan pembahasan detail untuk semua kategori CPNS & PPPK                <div class="floating-animation absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full"></div>                <div class="floating-animation absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full"></div>

                        </p>

                    </div>                <div class="floating-animation absolute top-40 right-20 w-32 h-32 bg-white/5 rounded-full" style="animation-delay: 1s;"></div>                <div class="floating-animation absolute top-40 right-20 w-32 h-32 bg-white/5 rounded-full" style="animation-delay: 1s;"></div>



                    <!-- Feature 2 -->                <div class="floating-animation absolute bottom-40 left-20 w-16 h-16 bg-white/10 rounded-full" style="animation-delay: 2s;"></div>                <div class="floating-animation absolute bottom-40 left-20 w-16 h-16 bg-white/10 rounded-full" style="animation-delay: 2s;"></div>
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-orange-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">            </div>            </div>
                        ...
                        <p class="text-gray-600 leading-relaxed">            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">

                            Pengalaman tryout yang persis seperti ujian asli dengan timer dan sistem penilaian akurat

                        </p>                <div class="max-w-4xl mx-auto">                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-green-200 transition-all duration-300 transform hover:-translate-y-2">                    <div class="inline-flex items-center glass-morphism px-6 py-3 rounded-full text-white mb-8">                    <div class="inline-flex items-center glass-morphism px-6 py-3 rounded-full text-white mb-8">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <i class="fas fa-chart-line text-white text-2xl"></i>                        <i class="fas fa-star text-yellow-300 mr-2"></i>                        <i class="fas fa-star text-yellow-300 mr-2"></i>

                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-4">Analisis Performa</h3>                        <span class="font-medium">Platform #1 Persiapan CPNS & PPPK Indonesia</span>                        <span class="font-medium">Platform #1 Persiapan CPNS & PPPK Indonesia</span>

                        <p class="text-gray-600 leading-relaxed">

                            Laporan detail kemampuanmu dengan rekomendasi materi yang perlu diperdalam                    </div>                    </div>
                    ...
                    <!-- Feature 4 -->                    <!-- Main Heading -->                    <!-- Main Heading -->
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-purple-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">                    <h1 class="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">                    <h1 class="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">

                            <i class="fas fa-trophy text-white text-2xl"></i>

                        </div>                        Raih Impian                         Raih Impian

                        <h3 class="text-xl font-bold text-gray-900 mb-4">Sistem Ranking</h3>

                        <p class="text-gray-600 leading-relaxed">                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-300">                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-300">
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-red-200 transition-all duration-300 transform hover:-translate-y-2">                        <br>Bersama Kami                        <br>Bersama Kami
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <i class="fas fa-book-open text-white text-2xl"></i>                    </h1>                    </h1>
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            ...
                            Ringkasan materi terkini sesuai kisi-kisi resmi dari berbagai instansi                    <!-- Subtitle -->                    <!-- Subtitle -->

                        </p>

                    </div>                    <p class="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">                    <p class="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">



                    <!-- Feature 6 -->                        Platform tryout online terlengkap dengan ribuan soal CPNS & PPPK,                         Platform tryout online terlengkap dengan ribuan soal CPNS & PPPK,
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-2xl hover:border-indigo-200 transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">                        pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu                        pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu
                        ...
                        </p>                    <!-- CTA Buttons -->                    <!-- CTA Buttons -->

                    </div>

                </div>                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">                                <i class="fas fa-tachometer-alt mr-2"></i>                                <i class="fas fa-tachometer-alt mr-2"></i>
                ...
                <div class="text-center mb-16">                                Mulai Belajar Sekarang                                Mulai Belajar Sekarang
                    ...
                    <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-6">
                        ...
                        Investasi Terbaik untuk                             <a href="{{ route('register') }}" class="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">                            <a href="{{ route('register') }}" class="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">

                        <span class="text-gradient">Masa Depanmu</span>

                    </h2>                                <i class="fas fa-rocket mr-2"></i>                                <i class="fas fa-rocket mr-2"></i>

                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">

                        Pilih paket yang sesuai dengan kebutuhanmu. Semua paket sudah termasuk akses penuh ke seluruh fitur platform                                Mulai Gratis Sekarang                                Mulai Gratis Sekarang
                ...
                <!-- Pricing Cards -->                        @endauth                        @endauth

                <div class="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">

                    <!-- Basic Plan -->                        <a href="#features" class="glass-morphism text-white hover:bg-white/20 px-8 py-4 rounded-xl font-bold text-lg transition-all">                        <a href="#features" class="glass-morphism text-white hover:bg-white/20 px-8 py-4 rounded-xl font-bold text-lg transition-all">

                    <div class="bg-white border border-gray-200 rounded-3xl p-8 relative">

                        <div class="text-center mb-8">                            <i class="fas fa-play mr-2"></i>                            <i class="fas fa-play mr-2"></i>
                        ...
                        <ul class="space-y-4 mb-8">                    </div>                    </div>
                            ...
                            <li class="flex items-center">
                                ...
                                <i class="fas fa-check text-green-500 mr-3"></i>                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">
                            ...
                            <li class="flex items-center">
                                ...
                                <i class="fas fa-check text-green-500 mr-3"></i>                            <div class="text-3xl font-black text-white mb-2">10K+</div>                            <div class="text-3xl font-black text-white mb-2">10K+</div>

                                <span class="text-gray-700">Akses materi dasar</span>

                            </li>                            <div class="text-blue-200 text-sm">Soal Tersedia</div>                            <div class="text-blue-200 text-sm">Soal Tersedia</div>

                            <li class="flex items-center text-gray-400">

                                <i class="fas fa-times mr-3"></i>                        </div>                        </div>
                            ...
                            </li>                            <div class="text-blue-200 text-sm">Peserta Aktif</div>                            <div class="text-blue-200 text-sm">Peserta Aktif</div>
                        ...
                        <a href="{{ route('register') }}" class="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-4 rounded-xl font-bold text-center block transition-colors">
                            ...
                            Mulai Gratis                        <div class="text-center">                        <div class="text-center">

                        </a>

                    </div>                            <div class="text-3xl font-black text-white mb-2">98%</div>                            <div class="text-3xl font-black text-white mb-2">98%</div>



                    <!-- Premium Plan -->                            <div class="text-blue-200 text-sm">Tingkat Kepuasan</div>                            <div class="text-blue-200 text-sm">Tingkat Kepuasan</div>
                    ...
                    <div class="bg-gradient-to-br from-blue-600 to-blue-700 border border-blue-500 rounded-3xl p-8 relative transform scale-105 shadow-2xl">
                        ...
                        <!-- Popular Badge -->                        </div>                        </div>

                        <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">

                            <div class="bg-orange-500 text-white px-6 py-2 rounded-full text-sm font-bold">                        <div class="text-center">                        <div class="text-center">

                                TERPOPULER ✨

                            </div>                            <div class="text-3xl font-black text-white mb-2">1K+</div>                            <div class="text-3xl font-black text-white mb-2">1K+</div>

                        </div>

                                                    <div class="text-blue-200 text-sm">Lulus ASN</div>                            <div class="text-blue-200 text-sm">Lulus ASN</div>

                        <div class="text-center mb-8">

                            <h3 class="text-2xl font-bold text-white mb-4">Paket Premium</h3>                        </div>                        </div>

                            <div class="text-4xl font-black text-white mb-2">Rp 99K</div>

                            <p class="text-blue-200">Per bulan</p>                    </div>                    </div>
                        ...
                        <ul class="space-y-4 mb-8">
                            ...
                            <li class="flex items-center">            <!-- Scroll Indicator -->            <!-- Scroll Indicator -->

                                <i class="fas fa-check text-green-300 mr-3"></i>

                                <span class="text-white">Tryout unlimited</span>            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">
