...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500 bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm" id="navbar">
        ...
        <div id="mobileMenu" class="xl:hidden fixed top-20 left-0 right-0 bottom-0 z-40 transform -translate-y-full opacity-0 transition-all duration-300 overflow-y-auto">
            <!-- Background -->
            <div class="bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-xl min-h-full">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mobile Dropdown Menu with defensive approach
