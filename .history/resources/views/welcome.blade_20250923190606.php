        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-2">
                    ...
                    <a href="#contact" class="nav-item relative px-6 py-3 font-bold text-gray-700 hover:text-blue-600 transition-all duration-300 rounded-xl hover:bg-blue-50 group">
            ...
            <div class="bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-xl">
                <div class="max-w-7xl mx-auto px-4 py-6">
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <a href="#contact" class="flex items-center space-x-4 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-cyan-50 hover:from-blue-100 hover:to-cyan-100 transition-all duration-300 group border border-blue-200/50">
                            ...
                            <span class="font-bold text-gray-800 group-hover:text-blue-700">Kontak Kami</span>
                        </a>
                    </div>
