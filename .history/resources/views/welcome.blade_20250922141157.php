    ...
    <section id="features" class="py-32 bg-gray-900 relative overflow-hidden">
        <div class="max-w-8xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                <!-- Feature 1 -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-blue-300 transition-all duration-300 transform hover:-translate-y-1">
                ...
                <!-- Feature 2 -->
                <div class="group bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-orange-300 transition-all duration-300 transform hover:-translate-y-1">
