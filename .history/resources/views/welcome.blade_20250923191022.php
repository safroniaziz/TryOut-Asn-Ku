...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500 bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center space-x-4">
                    <!-- Mobile Menu Button -->
                    <button id="mobileMenuBtn" class="xl:hidden relative p-2 text-gray-700 hover:text-blue-600 transition-all duration-300">
        ...
        <div id="mobileMenu" class="xl:hidden fixed top-20 left-0 right-0 z-40 transform -translate-y-full opacity-0 transition-all duration-300">
            <!-- Background -->
        ...
        <div class="grid grid-cols-5 gap-1 p-2">
            ...
            @auth
                <a href="{{ url('/dashboard') }}" class="text-center py-2">
                    <i class="fas fa-tachometer-alt text-cyan-600 mb-1"></i>
                    <div class="text-xs text-gray-600">Dashboard</div>
                </a>
            @else
                <a href="{{ route('register') }}" class="text-center py-2">
                    <i class="fas fa-user-plus text-cyan-600 mb-1"></i>
