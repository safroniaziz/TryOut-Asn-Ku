                                    ...
                                    <div class="flex flex-col items-end">
                                        @if($progressData['rank_position'] <= 100)
                                            <div class="text-xs font-bold text-orange-600 bg-orange-50 px-2 py-1 rounded-full mb-1">
                                                🌟 Top {{ $progressData['total_users'] > 0 ? round(($progressData['rank_position'] / $progressData['total_users']) * 100) : 0 }}%
                                            </div>
                                        @endif
                                ...
                                <div class="flex-grow flex flex-col justify-center">
                                    ...
                                    <div class="mb-3">
                                        <div class="flex justify-between items-center mb-1">
                                            ...
                                            <span class="text-xs font-bold text-orange-600">Top {{ $progressData['total_users'] > 0 ? round(($progressData['rank_position'] / $progressData['total_users']) * 100, 1) : 0 }}%</span>
                                        </div>
                                        <div class="w-full bg-gray-200 rounded-full h-1.5">
                                            <div class="bg-gradient-to-r from-orange-500 to-red-500 h-1.5 rounded-full transition-all duration-300" style="width: {{ $progressData['total_users'] > 0 ? min(100 - (($progressData['rank_position'] - 1) / $progressData['total_users']) * 100, 100) : 0 }}%"></div>
                                        </div>
                                    </div>
