            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 -mt-8">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div x-data="{ activeTab: 'all' }" class="mb-8">
                        ...
                        <!-- Tab Content -->
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-10 mt-10">
                            <!-- All Tab -->
                            ...
                            <div class="h-full flex flex-col">
                                ...
                                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden h-full flex flex-col">
                                    ...
                                    <!-- Professional Footer -->
                                    <div class="bg-gray-50 px-5 py-3 border-t border-gray-100 flex-shrink-0">
                                        ...
                                        @else
                                            <a href="{{ route('tryouts.index') }}?package={{ urlencode($package['name']) }}&type={{ request()->segment(1) ?? 'cpns' }}"
                                               class="flex items-center justify-center w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-4 px-6 rounded-xl transition-colors duration-200 text-center shadow-md hover:shadow-lg space-x-3">
                                                @if($package['is_completed_by_user'])
                                    ...
                                    <div class="bg-gray-50 px-5 py-3 border-t border-gray-100 flex-shrink-0">
                                        ...
                                        @else
                                            <a href="{{ route('tryouts.index') }}?package={{ urlencode($package['name']) }}&type=pppk"
                                               class="flex items-center justify-center w-full bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-bold py-4 px-6 rounded-xl transition-colors duration-200 text-center shadow-md hover:shadow-lg space-x-3">
                                                @if($package['is_completed_by_user'])
                                                    <i class="fas fa-redo"></i>
                                                    <span>Kerjakan Lagi</span>
                                                    <i class="fas fa-chart-line"></i>
