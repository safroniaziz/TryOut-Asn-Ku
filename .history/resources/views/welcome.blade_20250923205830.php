...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500 bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center space-x-4">
                    <!-- Mobile Menu Button -->
                    <button type="button" id="mobileMenuBtn" class="xl:hidden relative p-2 text-gray-700 hover:text-blue-600 transition-all duration-300 z-[70]">
        ...
        <div id="mobileMenu" class="xl:hidden fixed top-0 left-0 right-0 bottom-0 z-[60] bg-white shadow-xl h-0 opacity-0 transition-all duration-300 overflow-hidden">
            <div class="h-full flex flex-col overflow-y-auto">
                <!-- Menu content -->
                <div class="flex-1 max-w-7xl mx-auto px-4 py-6 w-full">
                    <!-- Close Button -->
                    <div class="flex justify-end mb-6">
                        <button id="mobileMenuClose" class="p-3 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-xl transition-all duration-300">
    ...
    <section id="features" class="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-base md:text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed px-4">
    ...
    <section class="py-20 bg-white border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                <div class="text-center group">
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 md:p-8 mb-4 group-hover:shadow-lg transition-all duration-300">
                        <div class="text-3xl md:text-4xl lg:text-5xl font-black text-blue-600 mb-2 px-2">NEW</div>
                        <div class="text-gray-600 font-semibold">Platform Fresh</div>
                    </div>
                </div>
                <div class="text-center group">
                    <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 md:p-8 mb-4 group-hover:shadow-lg transition-all duration-300">
                        <div class="text-3xl md:text-4xl lg:text-5xl font-black text-green-600 mb-2 px-2">MODERN</div>
                        <div class="text-gray-600 font-semibold">UI/UX Design</div>
                    </div>
                </div>
                <div class="text-center group">
                    <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 md:p-8 mb-4 group-hover:shadow-lg transition-all duration-300">
                        <div class="text-3xl md:text-4xl lg:text-5xl font-black text-orange-600 mb-2 px-2">50K+</div>
                        <div class="text-gray-600 font-semibold">Soal Premium</div>
                    </div>
                </div>
                <div class="text-center group">
                    <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 md:p-8 mb-4 group-hover:shadow-lg transition-all duration-300">
                        <div class="text-3xl md:text-4xl lg:text-5xl font-black text-purple-600 mb-2 px-2">24/7</div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleMobileMenu() {
                ...
                const isOpen = mobileMenu.classList.contains('h-full');

                if (isOpen) {
                    // Close menu
                    mobileMenu.classList.remove('h-full', 'opacity-100');
                    mobileMenu.classList.add('h-0', 'opacity-0');
                    if (mobileMenuBackdrop) {
                        mobileMenuBackdrop.classList.remove('opacity-50', 'pointer-events-auto');
                        mobileMenuBackdrop.classList.add('opacity-0', 'pointer-events-none');
                    }
                } else {
                    // Open menu
                    mobileMenu.classList.remove('h-0', 'opacity-0');
                    mobileMenu.classList.add('h-full', 'opacity-100');
                    if (mobileMenuBackdrop) {
                        mobileMenuBackdrop.classList.remove('opacity-0', 'pointer-events-none');
                        mobileMenuBackdrop.classList.add('opacity-50', 'pointer-events-auto');
                    }
                }
            }
