...
<head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">

    <meta charset="utf-8">

    <meta name="viewport" content="width=device-width, initial-scale=1">    <head><html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth"><html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">

    <title>TryOut ASNku - Platform Terbaik Persiapan CPNS & PPPK Indonesia</title>

    <meta name="description" content="Platform tryout online terlengkap untuk persiapan CPNS & PPPK. Ribuan soal, pembahasan detail, dan sistem ranking untuk mengukur kemampuanmu.">        <meta charset="utf-8">
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>        <title>TryOut ASNku - Platform Terbaik Persiapan CPNS & PPPK Indonesia</title>
    ...
    <!-- Scripts -->        <!-- Fonts -->        <meta name="viewport" content="width=device-width, initial-scale=1">        <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <style>
        ...
        .gradient-bg {        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>        <title>TryOut ASNku - Platform Terbaik Persiapan CPNS & PPPK Indonesia</title>        <title>TryOut ASNku - Platform Terbaik Persiapan CPNS & PPPK Indonesia</title>

            background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 25%, #3b82f6 50%, #f97316 75%, #ea580c 100%);

            background-size: 400% 400%;        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
