...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500 bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm" id="navbar">
        ...
        <div id="mobileMenu" class="xl:hidden fixed top-[80px] left-0 right-0 z-[60] bg-white border-b border-gray-200 shadow-xl transform translate-y-[-100%] opacity-0 transition-all duration-300 min-h-[calc(100vh-80px)] overflow-y-auto">
