...
<body class="font-inter antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-500 bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm" id="navbar">
        ...
        <div id="mobileMenuBackdrop" class="xl:hidden fixed inset-0 bg-black/50 z-30 opacity-0 pointer-events-none transition-opacity duration-300"></div>

        <!-- Mobile Dropdown Menu -->
        <div id="mobileMenu" class="xl:hidden fixed top-20 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-xl transform -translate-y-full opacity-0 transition-all duration-300 max-h-screen overflow-y-auto">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function openMobileMenu() {
                ...
                // Prevent scroll on main content (lebih baik dari overflow hidden)
