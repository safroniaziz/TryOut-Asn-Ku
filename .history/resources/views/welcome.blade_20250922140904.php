...
<body class="font-inter antialiased overflow-x-hidden">
        ...
        <div class="max-w-8xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div class="text-center mb-20">
                ...
                <h2 class="text-5xl md:text-7xl font-black text-white mb-8 font-space">
                    <span class="text-gradient-premium">Revolusi</span> TryOut
                    <br>untuk <span class="text-gradient-gold">Generasi ASN</span>
                </h2>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
                    <!-- Feature 1 -->
                    <div class="group bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-3xl p-10 hover:shadow-2xl hover:border-blue-300/50 transition-all duration-500 transform hover:-translate-y-3 hover:bg-white">
                        <div class="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-database text-white text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">50,000+ Soal Premium</h3>
                    ...
                    <!-- Feature 2 -->
                    <div class="group bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-3xl p-10 hover:shadow-2xl hover:border-orange-300/50 transition-all duration-500 transform hover:-translate-y-3 hover:bg-white">
                        <div class="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-stopwatch text-white text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Simulasi Real-Time</h3>
                        <p class="text-gray-600 leading-relaxed text-lg">
                    ...
                    <!-- Feature 3 -->
                    <div class="group bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-3xl p-10 hover:shadow-2xl hover:border-green-300/50 transition-all duration-500 transform hover:-translate-y-3 hover:bg-white">
                        <div class="w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-chart-bar text-white text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Analisis Mendalam</h3>
                        <p class="text-gray-600 leading-relaxed text-lg">
                    ...
                    <!-- Feature 4 -->
                    <div class="group bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-3xl p-10 hover:shadow-2xl hover:border-purple-300/50 transition-all duration-500 transform hover:-translate-y-3 hover:bg-white">
                        <div class="w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-600 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-crown text-white text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Leaderboard Nasional</h3>
                        <p class="text-gray-600 leading-relaxed text-lg">
                    ...
                    <!-- Feature 5 -->
                    <div class="group bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-3xl p-10 hover:shadow-2xl hover:border-red-300/50 transition-all duration-500 transform hover:-translate-y-3 hover:bg-white">
                        <div class="w-20 h-20 bg-gradient-to-br from-red-500 to-red-600 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-graduation-cap text-white text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Modul Pembelajaran</h3>
                        <p class="text-gray-600 leading-relaxed text-lg">
                    ...
                    <!-- Feature 6 -->
                    <div class="group bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-3xl p-10 hover:shadow-2xl hover:border-indigo-300/50 transition-all duration-500 transform hover:-translate-y-3 hover:bg-white">
                        <div class="w-20 h-20 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-rocket text-white text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Platform Revolusioner</h3>
                        <p class="text-gray-600 leading-relaxed text-lg">
    ...
    <!-- Stats Section -->
    <section class="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-600 relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-r from-blue-900/20 to-orange-900/20"></div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-6xl font-black text-white mb-6">
                    Dipercaya <span class="text-yellow-300">Ribuan</span> Peserta
                </h2>
                <p class="text-xl text-white/80 max-w-3xl mx-auto">
                    Bergabunglah dengan komunitas terbesar calon ASN Indonesia
                </p>
            </div>
            
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center">
                    <div class="text-5xl md:text-6xl font-black text-white mb-2">15K+</div>
                    <div class="text-white/80 font-medium">Peserta Aktif</div>
                </div>
                <div class="text-center">
                    <div class="text-5xl md:text-6xl font-black text-yellow-300 mb-2">89%</div>
                    <div class="text-white/80 font-medium">Tingkat Kelulusan</div>
                </div>
                <div class="text-center">
                    <div class="text-5xl md:text-6xl font-black text-white mb-2">50K+</div>
                    <div class="text-white/80 font-medium">Soal Premium</div>
                </div>
                <div class="text-center">
                    <div class="text-5xl md:text-6xl font-black text-yellow-300 mb-2">24/7</div>
                    <div class="text-white/80 font-medium">Support Sistem</div>
                </div>
            </div>
        </div>
    </section>
