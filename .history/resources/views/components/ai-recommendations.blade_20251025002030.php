                                    ...
                                    <div>
                                        <div class="mb-2">
                                            <div class="flex items-center space-x-2 mb-1">
                                                <h6 class="text-xs font-medium text-gray-600">💡 Langkah-langkah yang disarankan:</h6>
                                                <div class="group relative">
                                                    <i class="fas fa-info-circle text-blue-500 text-xs cursor-help hover:text-blue-600"></i>
                                                    <div class="absolute left-0 top-6 w-64 bg-white border border-gray-300 text-gray-800 text-xs rounded-lg p-3 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-20">
                                            ...
                                            <p class="text-xs text-gray-500 italic">Klik icon info untuk penjelasan lebih detail</p>
                                        </div>
                                        <div class="space-y-1">
