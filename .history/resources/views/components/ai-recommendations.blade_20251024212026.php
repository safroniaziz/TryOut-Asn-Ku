            ...
            <div class="p-8 bg-gradient-to-br from-blue-50 to-indigo-50">
                ...
                <div class="mt-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h4 class="text-lg font-semibold text-green-900">🏆 Sistem Achievement</h4>
                            <p class="text-green-700">Kumpulkan badge dan dapatkan cashback!</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div class="text-center bg-white rounded-lg p-4">
                            <div class="text-2xl font-bold text-blue-600">Paket 3</div>
                            <div class="text-gray-600 mb-2">Pembelajar Gigih</div>
                            <div class="text-green-600 font-bold">Rp 5.000</div>
                        </div>
                        <div class="text-center bg-white rounded-lg p-4">
                            <div class="text-2xl font-bold text-purple-600">Paket 6</div>
                            <div class="text-gray-600 mb-2">Ahli Analisis</div>
                            <div class="text-green-600 font-bold">Rp 5.000</div>
                        </div>
                        <div class="text-center bg-white rounded-lg p-4">
                            <div class="text-2xl font-bold text-yellow-600">Paket 10</div>
                            <div class="text-gray-600 mb-2">Grand Master</div>
                            <div class="text-green-600 font-bold">Rp 5.000</div>
                        </div>
                    </div>
                    <div class="mt-4 text-center">
                        <div class="text-sm text-gray-600">
                            ...
                            Total Cashback: <span class="font-bold text-green-600">Rp 15.000</span>
                        </div>
                    </div>
                </div>
            </div>
