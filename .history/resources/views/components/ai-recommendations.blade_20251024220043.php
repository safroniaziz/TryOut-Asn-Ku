    ...
    @if(isset($aiRecommendations['personalized_plan']))
        <div class="bg-white rounded-3xl border border-gray-200/50 shadow-xl overflow-hidden">
            ...
            <div class="p-8 bg-gradient-to-br from-blue-50 to-cyan-50">
                ...
                <!-- How System Works -->
                <div class="mt-8 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl p-6 border border-gray-200">
                    <div class="text-center">
                        ...
                        <h4 class="text-lg font-bold text-gray-900 mb-4">🔬 Bagaimana Sistem Ini Bekerja?</h4>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-700">
                            <div class="text-center">
                                <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                                    <i class="fas fa-database text-blue-600"></i>
                                </div>
                                <h5 class="font-bold text-gray-900 mb-1">1. Data Collection</h5>
                                <p class="text-xs">Menganalisis {{ auth()->user()->leaderboards()->count() }} tryout Anda</p>
                            </div>
                            <div class="text-center">
                                <div class="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                                    <i class="fas fa-brain text-purple-600"></i>
                                </div>
                                <h5 class="font-bold text-gray-900 mb-1">2. Pattern Recognition</h5>
                                <p class="text-xs">Statistical analysis untuk deteksi pola</p>
                            </div>
                            <div class="text-center">
                                <div class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                                    <i class="fas fa-user-cog text-green-600"></i>
                                </div>
                                <h5 class="font-bold text-gray-900 mb-1">3. Personalization</h5>
                                <p class="text-xs">Rekomendasi unik untuk Anda</p>
                            </div>
                        </div>
                        <div class="mt-4 p-3 bg-white rounded-lg border border-gray-200">
                            <p class="text-xs text-gray-600">
                                <strong>💡 Mengapa Setiap User Berbeda?</strong> Sistem menganalisis data performa,
                                gaya belajar, dan pola study yang unik untuk setiap individu!
                            </p>
                        </div>
                    </div>
                </div>
