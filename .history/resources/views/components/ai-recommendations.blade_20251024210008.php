            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">📊 Analisis Performa Anda</h3>
                            <p class="text-gray-600">Temukan kekuatan dan area yang perlu ditingkatkan</p>
                        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6 border-b border-gray-100">
                <div class="flex items-center">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900">📚 Rencana Belajar Anda</h3>
                        <p class="text-gray-600">Strategi belajar yang disesuaikan dengan performa Anda</p>
                    </div>
                </div>
