                                    ...
                                    <div>
                                        <div class="flex items-center justify-between mb-2">
                                            ...
                                            <div class="group relative">
                                                ...
                                                <div class="absolute right-0 top-5 w-48 bg-gray-800 text-white text-xs rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10">
                                                    Aktivitas belajar spesifik yang disesuaikan dengan gaya belajar dan area fokus Anda
                                                </div>
                                            </div>
                                        </div>
                                        <div class="space-y-1">
