...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    @if(isset($aiRecommendations['gamification_challenges']) && count($aiRecommendations['gamification_challenges']) > 0)
        <div class="bg-white rounded-3xl border border-gray-200/50 shadow-xl overflow-hidden">
            <!-- Header -->
            <div class="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 px-8 py-8">
                <div class="flex items-center space-x-4">
                    <div class="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                        <i class="fas fa-trophy text-white text-2xl"></i>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold text-white mb-2">🏆 Tantangan & Achievement</h3>
                        <p class="text-white/90 text-lg">Selesaikan tantangan berjenjang dan dapatkan cashback!</p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <div class="flex items-center justify-between mb-6">
                                    <span class="px-4 py-2 text-sm font-bold rounded-full {{
                                        $challenge['difficulty'] === 'easy' ? 'bg-gradient-to-r from-yellow-400 to-yellow-600 text-white' :
                                        ($challenge['difficulty'] === 'medium' ? 'bg-gradient-to-r from-gray-400 to-gray-600 text-white' :
                                ...
                                <!-- Progress Bar -->
                                <div class="mb-6">
                                    <div class="flex items-center justify-between text-sm font-medium text-gray-600 mb-3">
                                        <span>Progress</span>
                                        <span>{{ $challenge['completion_rate'] }}%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                                        <div class="h-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full transition-all duration-1000 ease-out"
                                ...
                                <div class="flex items-center justify-between mb-6">
                                    <div class="flex items-center text-sm text-gray-600">
                                        ...
                                        <span class="font-medium">{{ $challenge['badge_name'] ?? 'Achievement Badge' }}</span>
                                    </div>
                                    <div class="flex items-center text-sm text-gray-600">
                                        <i class="fas fa-clock mr-2 text-blue-500"></i>
                                        <span class="font-medium">{{ $challenge['estimated_time'] ?? '1 minggu' }}</span>
                                    </div>
                                </div>

                                <!-- Action Button -->
                                <button class="w-full px-6 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
        ...
        <div class="bg-white rounded-3xl border border-gray-200/50 shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 px-8 py-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold text-white mb-2">🚀 Upgrade ke Premium</h3>
                        <p class="text-white/90 text-lg">Akses analisis AI yang lebih mendalam dan rekomendasi personal</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8 bg-gradient-to-br from-blue-50 to-indigo-50">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                    <div class="text-center group">
                        ...
                        <h4 class="text-xl font-bold text-gray-900 mb-3">Analisis AI Mendalam</h4>
                        <p class="text-gray-600 leading-relaxed">Prediksi performa dan strategi belajar optimal berdasarkan data personal Anda</p>
                    </div>
                    <div class="text-center group">
                        ...
                        <p class="text-gray-600 leading-relaxed">Monitor kemajuan belajar secara real-time dengan dashboard yang interaktif</p>
                    </div>
                    <div class="text-center group">
                        ...
                        <h4 class="text-xl font-bold text-gray-900 mb-3">Rekomendasi Personal</h4>
                        <p class="text-gray-600 leading-relaxed">Strategi belajar yang disesuaikan dengan gaya dan kebutuhan Anda</p>
                    </div>
                </div>

                <!-- Upgrade CTA -->
                <div class="text-center bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                    <h4 class="text-2xl font-bold text-gray-900 mb-4">Siap Tingkatkan Performa Belajar?</h4>
                    <p class="text-gray-600 mb-8 text-lg">Bergabunglah dengan ribuan user yang sudah merasakan manfaat Premium</p>
                    <button class="px-12 py-5 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white font-bold text-xl rounded-2xl hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
                        <i class="fas fa-rocket mr-4"></i>
                        Mulai Premium Sekarang
                    </button>
                    <div class="flex items-center justify-center mt-6 space-x-6 text-sm text-gray-500">
                        <div class="flex items-center">
