            ...
            <div class="p-8 bg-gradient-to-br from-blue-50 to-indigo-50">
                            ...
                            <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="h-2 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full transition-all duration-500"
                                ...
                                <div class="flex items-center justify-between mb-6">
                                    ...
                                    <div class="flex items-center text-sm text-gray-600">
                                        ...
                                        <span class="font-medium">Target Belajar</span>
                                    </div>
                                </div>
                ...
                <div class="mt-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div class="text-center">
                            <div class="text-2xl font-bold text-orange-600">Sedang</div>
                            <div class="text-gray-600">Rp 20.000 - 50.000</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-red-600">Sulit</div>
