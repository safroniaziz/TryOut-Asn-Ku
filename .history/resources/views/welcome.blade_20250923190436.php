            ...
            <div class="bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-xl">
                <div class="max-w-7xl mx-auto px-4 py-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="relative overflow-hidden bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 text-white p-4 rounded-xl font-bold text-center transition-all duration-300 hover:shadow-lg group border border-blue-400">
                                <div class="absolute inset-0 bg-gradient-to-r from-blue-400 to-indigo-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                <span class="relative z-10">
