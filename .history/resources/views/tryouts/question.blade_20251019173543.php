        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div class="relative">
                ...
                <div class="w-full bg-white/10 rounded-full h-3">
                    <div class="bg-gradient-to-r from-green-400 to-emerald-500 h-3 rounded-full transition-all duration-500 shadow-lg" style="width: {{ $progressPercentage }}%"></div>
                </div>
                <div class="flex justify-between mt-2">
                    <span class="text-white/80 text-sm">{{ number_format($progressPercentage, 1) }}% Complete</span>
                    <span class="text-white/80 text-sm">{{ $answeredCount }} / {{ $allSoals->count() }} soal</span>
                </div>
            </div>
        </div>
    </div>
