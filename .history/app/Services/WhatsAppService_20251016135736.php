...
class WhatsAppService
{
    ...
    public static function sendOTP($phoneNumber, $otpCode)
    {
        ...
        class WhatsAppService
        {
            ...
            /**
             * Send OTP via Fonnte only. This app is configured to use Fonnte as the
             * WhatsApp provider. Make sure to set FONNTE_API_KEY and FONNTE_SENDER_NUMBER
             * in your environment (.env) when hosting.
             *
             * @param string $phone
             * @param string $otp
             * @return bool
             */
            public function sendOTPViaFonnte(string $phone, string $otp): bool
            {
