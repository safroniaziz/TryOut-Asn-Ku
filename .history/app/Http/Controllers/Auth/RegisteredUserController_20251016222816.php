...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($parentId && $request->used_referral_code) {
            ...
            // Log referral usage
            ActivityLogService::logReferralUsed(
                $request->used_referral_code, 
                $user->id, 
                $parentId
            );
        }
        ...
        ActivityLogService::logUserRegistration($user, [
            ...
            'referral_used' => !empty($request->used_referral_code),
            'education_level' => $request->education_level,
            'target_test' => $request->target_test,
            'city' => $request->city
        ]);
        ...
        ActivityLogService::logUserLogin($user, true, 'registration_auto_login');
