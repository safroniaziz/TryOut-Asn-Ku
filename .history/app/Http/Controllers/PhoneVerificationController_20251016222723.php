...
class PhoneVerificationController extends Controller
{
    ...
    public function sendOTP(Request $request)
    {
        ...
        if (RateLimiter::tooManyAttempts($rateLimitKey, 5)) {
            ...
            ActivityLogService::logRateLimitExceeded('OTP per phone', $phoneNumber, 5);
        ...
        if (RateLimiter::tooManyAttempts($globalRateKey, 30)) {
            ...
            ActivityLogService::logRateLimitExceeded('OTP per IP', $request->ip(), 30);
    ...
    public function verifyOTP(Request $request)
    {
        ...
        // Get verification attempts for this phone number
        ...
        if (PhoneVerification::verifyOTP($phoneNumber, $otpCode)) {
            ...
            ActivityLogService::logOTPVerified($phoneNumber, true, $attempts);
            ...
            Cache::put($attemptKey, $attempts, 600); // 10 minutes
            
            // Log failed verification
            ActivityLogService::logOTPVerified($phoneNumber, false, $attempts);
            
            // Log suspicious activity after multiple failed attempts
            if ($attempts >= 5) {
                ActivityLogService::logSuspiciousActivity(
                    'Multiple failed OTP attempts', 
                    ['phone_number' => $phoneNumber, 'attempts' => $attempts]
                );
            }
