...
class TryoutController extends Controller
{
    ...
    public function start(Request $request, Tryout $tryout)
    {
        ...
        // Get first question
        $soal = $tryout->soals()->orderBy('kategori')->orderBy('nomor_soal')->first();
        ...
        if ($request->ajax()) {
            ...
            $allSoals = $tryout->soals()->orderBy('kategori')->orderBy('nomor_soal')->get();
    ...
    public function answer(Request $request, Tryout $tryout)
    {
        ...
        if ($request->ajax()) {
            ...
            $nextSoal = $tryout->soals()
                ...
                ->orderBy('kategori')->orderBy('nomor_soal')
                ->first();
