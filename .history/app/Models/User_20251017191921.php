 ...
 * @property string|null $used_referral_code
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * 
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\JawabanUser> $jawabanUsers
...
class User extends Authenticatable
{
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly([
                'name', 'email', 'phone_number', 'target_test',
                'experience_level', 'target_institution', 'motivation',
                'university', 'city', 'province', 'institution',
                'study_program'
            ])
            ->logOnlyDirty()
            ->dontSubmitEmptyLogs()
