...
class UniversitasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $universitasNegeri = [
            ...
            ['nama_universitas' => 'Universitas Negeri Jakarta', 'singkatan' => 'UNJ', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
        ...
        $universitasSwasta = [
            // 1-10
            ['nama_universitas' => 'Universitas Bina Nusantara', 'singkatan' => 'BINUS', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Tarumanagara', 'singkatan' => 'UNTAR', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Trisakti', 'singkatan' => 'TRISAKTI', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Katolik Parahyangan', 'singkatan' => 'UNPAR', 'kota' => 'Bandung', 'provinsi' => 'Jawa Barat'],
            ['nama_universitas' => 'Universitas Atma Jaya Jakarta', 'singkatan' => 'UAJY', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ...
            ['nama_universitas' => 'Universitas Muhammadiyah Jakarta', 'singkatan' => 'UMJ', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Muhammadiyah Semarang', 'singkatan' => 'UNIMUS', 'kota' => 'Semarang', 'provinsi' => 'Jawa Tengah'],
            ['nama_universitas' => 'Universitas Mercu Buana', 'singkatan' => 'UMB', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ...
            ['nama_universitas' => 'Universitas Pancasila', 'singkatan' => 'UP', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],

            // 21-30
            ['nama_universitas' => 'Universitas Nasional', 'singkatan' => 'UNAS', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Esa Unggul', 'singkatan' => 'UEU', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Al Azhar Indonesia', 'singkatan' => 'UAI', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Kristen Indonesia', 'singkatan' => 'UKI', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ...
            ['nama_universitas' => 'Universitas Pembangunan Nasional Veteran Jakarta', 'singkatan' => 'UPNVJ', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ...
            ['nama_universitas' => 'Universitas Katolik Indonesia Atma Jaya', 'singkatan' => 'Unika Atma Jaya', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Paramadina', 'singkatan' => 'PARAMADINA', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
            ['nama_universitas' => 'Universitas Bakrie', 'singkatan' => 'UB', 'kota' => 'Jakarta', 'provinsi' => 'DKI Jakarta'],
