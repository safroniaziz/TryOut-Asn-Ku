...
class InstansiSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $kementerian = [
            ['nama_instansi' => 'Kementerian Dalam Negeri', 'singkatan' => 'Kemendagri', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Luar Negeri', 'singkatan' => 'Kemenlu', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Pertahanan', 'singkatan' => 'Kemhan', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Hukum dan Hak Asasi Manusia', 'singkatan' => 'Kemenkumham', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Keuangan', 'singkatan' => 'Kemenkeu', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Energi dan Sumber Daya Mineral', 'singkatan' => 'Kemen ESDM', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Perindustrian', 'singkatan' => 'Kemenperin', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Perdagangan', 'singkatan' => 'Kemendag', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Pertanian', 'singkatan' => 'Kementan', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Kehutanan', 'singkatan' => 'Kemenhut', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Perhubungan', 'singkatan' => 'Kemenhub', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Pekerjaan Umum dan Perumahan Rakyat', 'singkatan' => 'Kemen PUPR', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Kesehatan', 'singkatan' => 'Kemenkes', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi', 'singkatan' => 'Kemendikbudristek', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Sosial', 'singkatan' => 'Kemensos', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Tenaga Kerja', 'singkatan' => 'Kemnaker', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Pemberdayaan Perempuan dan Perlindungan Anak', 'singkatan' => 'Kemen PPPA', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Lingkungan Hidup dan Kehutanan', 'singkatan' => 'Kemen LHK', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Kelautan dan Perikanan', 'singkatan' => 'KKP', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Pariwisata dan Ekonomi Kreatif', 'singkatan' => 'Kemenparekraf', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Komunikasi dan Informatika', 'singkatan' => 'Kominfo', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Koperasi dan Usaha Kecil dan Menengah', 'singkatan' => 'Kemenkop UKM', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Pemuda dan Olahraga', 'singkatan' => 'Kemenpora', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Perencanaan Pembangunan Nasional', 'singkatan' => 'Bappenas', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Badan Usaha Milik Negara', 'singkatan' => 'Kemen BUMN', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Agraria dan Tata Ruang', 'singkatan' => 'Kemen ATR/BPN', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Desa, Pembangunan Daerah Tertinggal, dan Transmigrasi', 'singkatan' => 'Kemendes PDTT', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Agama', 'singkatan' => 'Kemenag', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Riset dan Teknologi', 'singkatan' => 'Kemenristek', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
            ['nama_instansi' => 'Kementerian Investasi', 'singkatan' => 'Kemeninvest', 'jenis' => 'kementerian', 'kategori' => 'kementerian'],
        ];
        ...
        // Call seeder untuk kabupaten dan kota
        $this->call([
            InstansiKabupatenSeeder::class,
            InstansiKabupatenJawaSeeder::class,
            InstansiKotaSeeder::class,
        ]);
    }
}
