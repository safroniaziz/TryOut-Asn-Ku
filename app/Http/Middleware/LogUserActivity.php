...
class LogUserActivity
{
    ...
    private function getActivityDescription(Request $request, ?string $routeName): string
    {
        $actionMap = [
            ...
            'profile.edit' => 'Melihat Halaman Edit Profil',
            'profile.update' => 'Memperbarui Profil',
            'tryouts.index' => 'Melihat Daftar Tryout',
            'tryouts.show' => 'Melihat Detail Tryout',
            'tryouts.start' => 'Memulai Tryout',
            'tryouts.submit' => 'Mengirim Jawaban Tryout',
            'leaderboard' => 'Melihat Papan Peringkat',
            'subscription.index' => 'Melihat Daftar Langganan',
            'subscription.create' => 'Membuat Langganan Baru',
        ];
